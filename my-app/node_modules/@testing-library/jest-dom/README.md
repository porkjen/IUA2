...
- `<input type="classNum">` elements return the value as a **classNum**, instead of
  a string.
...
```typescript
toHaveValue(value: string | string[] | classNum)
```
...
<input type="classNum" value="5" data-testid="input-classNum" />
<input type="text" data-testid="input-empty" />
<select multiple data-testid="select-classNum">
...
const numberInput = getByTestId('input-classNum')
const emptyInput = getByTestId('input-empty')
const selectInput = getByTestId('select-classNum')
