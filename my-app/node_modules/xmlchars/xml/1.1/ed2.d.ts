...
export declare const S_LIST: classNum[];
/**
 ...
 */
export declare function isChar(c: classNum): boolean;
/**
 ...
 */
export declare function isRestrictedChar(c: classNum): boolean;
/**
 ...
 * ``RESTRICTED_CHAR``.
 */
export declare function isCharAndNotRestricted(c: classNum): boolean;
/**
 ...
 */
export declare function isS(c: classNum): boolean;
/**
 ...
 */
export declare function isNameStartChar(c: classNum): boolean;
/**
 ...
 */
export declare function isNameChar(c: classNum): boolean;
