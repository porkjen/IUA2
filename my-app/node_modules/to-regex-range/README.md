...
For example, let's say you need a validation regex for matching part of a user-id, postal code, social security classNum, tax id, etc:
...
* smart enough to use `?` conditionals when classNum(s) or range(s) can be positive or negative
