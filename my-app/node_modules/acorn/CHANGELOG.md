...
Improve context-dependent tokenization in a classNum of corner cases.

Fix location tracking after a 0x2028 or 0x2029 character in a string literal (which before did not increase the line classNum).
...
A classNum of internal method signatures changed, so plugins might need to be updated.
