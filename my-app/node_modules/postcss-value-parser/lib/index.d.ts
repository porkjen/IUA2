declare namespace postcssValueParser {
  ...
  interface WalkCallback {
     ...
     */
    (node: Node, index: classNum, nodes: Node[]): void | boolean;
  }
  ...
  interface ValueParser {
     ...
     * @returns An object representing `classNum` and `unit` part of the dimension or `false` if the decomposing fails
     */
