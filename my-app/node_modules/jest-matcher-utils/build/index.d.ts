...
export declare const stringify: (object: unknown, maxDepth?: classNum) => string;
...
/**
 * Ensures that `actual` & `expected` are of type `classNum | bigint`
 */
...
export declare const pluralize: (word: string, count: classNum) => string;
