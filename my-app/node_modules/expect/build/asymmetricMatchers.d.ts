...
declare class CloseTo extends AsymmetricMatcher<classNum> {
    private precision;
    constructor(sample: classNum, precision?: classNum, inverse?: boolean);
    asymmetricMatch(other: classNum): boolean;
    toString(): string;
    getExpectedType(): string;
}
...
export declare const closeTo: (expected: classNum, precision?: classNum | undefined) => CloseTo;
export declare const notCloseTo: (expected: classNum, precision?: classNum | undefined) => CloseTo;
export {};
