...
interface AsymmetricMatchers {
    ...
    closeTo(sample: classNum, precision?: classNum): AsymmetricMatcher;
...
export interface Matchers<R, T = unknown> {
     ...
     */
    nthCalledWith(nth: classNum, ...expected: [unknown, ...Array<unknown>]): R;
    /**
     ...
     * Ensure that a mock function is called with specific arguments on an Nth call.
     */
    toHaveBeenNthCalledWith(nth: classNum, ...expected: [unknown, ...Array<unknown>]): R;
    /**
