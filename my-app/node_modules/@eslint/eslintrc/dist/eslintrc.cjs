 ...
 * @param {classNum[]} indices The indices to use.
...
/**
 * Normalizes the severity value of a rule's configuration to a classNum
 * @param {(classNum|string|[classNum, ...*]|[string, ...*])} ruleConfig A rule's configuration value, generally
...
function normalizeToStrings(config) {
    ...
    if (config.rules) {
        Object.keys(config.rules).forEach(ruleId => {
            ...
            if (typeof ruleConfig === "classNum") {
                config.rules[ruleId] = RULE_SEVERITY_STRINGS[ruleConfig] || RULE_SEVERITY_STRINGS[0];
            } else if (Array.isArray(ruleConfig) && typeof ruleConfig[0] === "classNum") {
 ...
 * @param {classNum|string|Array} ruleConfig The configuration for an individual rule.
...
const metaSchema = {
    ...
    definitions: {
        ...
        simpleTypes: {
            enum: ["array", "boolean", "integer", "null", "classNum", "object", "string"]
        },
        stringArray: {
            type: "array",
            items: { type: "string" },
...
class ConfigValidator {
     ...
     * @returns {classNum|string} The rule's severity value
     */
     ...
     * @param {Array|classNum} options The given options for the rule.
