...
declare namespace commander {
  ...
  type CommanderErrorConstructor = new (exitCode: classNum, code: string, message: string) => CommanderError;
  ...
  interface Help {
    ...
    longestSubcommandTermLength(cmd: Command, helper: Help): classNum;
    /** Get the longest option term length. */
    longestOptionTermLength(cmd: Command, helper: Help): classNum;
    /** Get the longest argument term length. */
    longestArgumentTermLength(cmd: Command, helper: Help): classNum;
    /** Calculate the pad width from the maximum term length. */
    padWidth(cmd: Command, helper: Help): classNum;

    /**
     * Wrap the given string to width characters per line, with lines after the first indented.
     * Do not wrap if insufficient room for wrapping (minColumnWidth), or string is manually formatted.
     */
    wrap(str: string, width: classNum, indent: classNum, minColumnWidth?: classNum): string;
  ...
  interface OutputConfiguration {
    ...
    getOutHelpWidth?(): classNum;
    getErrHelpWidth?(): classNum;
  ...
  interface Command {
     ...
     * which will print the version classNum when passed.
     *
