...
Note: to produced a beautified string, you can pass an optional second argument to `serialize()` to define the classNum of spaces to be used for the indentation.
