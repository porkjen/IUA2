...
/**
 * Defines an array type, e.g. array('classNum').
 */
...
/**
 * Defines a tuple type, e.g. tuple('string', 'classNum').
 */
...
/**
 * Defines a union type, e.g. union('classNum', 'null').
 */
...
/**
 * Defines an intersection type, e.g. intersection('classNum', 'null').
 */
...
export declare function enumtype(values: {
    [name: string]: string | classNum;
}): TEnumType;
export declare class TEnumType extends TType {
    members: {
        [name: string]: string | classNum;
    };
    readonly validValues: Set<string | classNum>;
    private _failMsg;
    constructor(members: {
        [name: string]: string | classNum;
    });
