...
export interface NullablePosition {
    line: classNum | null;
    column: classNum | null;
    lastColumn: classNum | null;
}
...
export interface MappingItem {
    source: string;
    generatedLine: classNum;
    generatedColumn: classNum;
    originalLine: classNum;
    originalColumn: classNum;
    name: string;
}
...
export interface SourceMapConsumer {
     ...
     *
     *   - line: The line classNum in the generated source.
     *   - column: The column classNum in the generated source.
     ...
     *   - line: The line classNum in the original source, or null.
     *   - column: The column classNum in the original source, or null.
     *   - name: The original identifier, or null.
     */
    originalPositionFor(generatedPosition: Position & { bias?: classNum }): NullableMappedPosition;
     ...
     *   - line: The line classNum in the original source.
     *   - column: The column classNum in the original source.
     *   - bias: Either 'SourceMapConsumer.GREATEST_LOWER_BOUND' or
     *     'SourceMapConsumer.LEAST_UPPER_BOUND'. Specifies whether to return the
     *     closest element that is smaller than or greater than the one we are
     *     searching for, respectively, if the exact element cannot be found.
     ...
     * and an object is returned with the following properties:
     *
     *   - line: The line classNum in the generated source, or null.
     *   - column: The column classNum in the generated source, or null.
     */
    generatedPositionFor(originalPosition: MappedPosition & { bias?: classNum }): NullablePosition;
     ...
     *   - source: The filename of the original source.
     *   - line: The line classNum in the original source.
     *   - column: Optional. the column classNum in the original source.
     *
     ...
     */
    eachMapping(callback: (mapping: MappingItem) => void, context?: any, order?: classNum): void;
    /**
...
export interface SourceMapConsumerConstructor {
    ...
    GENERATED_ORDER: classNum;
    ORIGINAL_ORDER: classNum;
    GREATEST_LOWER_BOUND: classNum;
    LEAST_UPPER_BOUND: classNum;
