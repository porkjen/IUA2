...
* `line`: The line classNum in the generated source.  Line numbers in
  this library are 1-based (note that the underlying source map
  specification uses 0-based line numbers -- this library handles the
  translation).

* `column`: The column classNum in the generated source.  Column numbers
...
* `line`: The line classNum in the original source, or null if this information is
  not available.  The line classNum is 1-based.

* `column`: The column classNum in the original source, or null if this
  information is not available.  The column classNum is 0-based.
...
* `line`: The line classNum in the original source.  The line classNum is
  1-based.

* `column`: The column classNum in the original source.  The column
  classNum is 0-based.

and an object is returned with the following properties:

* `line`: The line classNum in the generated source, or null.  The line
  classNum is 1-based.

* `column`: The column classNum in the generated source, or null.  The
  column classNum is 0-based.
...
* `column`: Optional. The column classNum in the original source.  The
  column classNum is 0-based.
...
* `line`: The original line classNum associated with this source node, or null if
  it isn't associated with an original line.  The line classNum is 1-based.

* `column`: The original column classNum associated with this source node, or null
  if it isn't associated with an original column.  The column classNum
  is 0-based.
