 ...
 */
export declare function decode(data: string, level?: classNum): string;
/**
 ...
 */
export declare function decodeStrict(data: string, level?: classNum): string;
/**
 ...
 */
export declare function encode(data: string, level?: classNum): string;
