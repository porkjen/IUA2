...
export declare function getTokenAtPosition(parent: ts.Node, pos: classNum, sourceFile?: ts.SourceFile, allowJsDoc?: boolean): ts.Node | undefined;
/**
...
*/
export declare function getCommentAtPosition(sourceFile: ts.SourceFile, pos: classNum, parent?: ts.Node): ts.CommentRange | undefined;
/**
 * Returns whether the specified position is inside a comment.
 * You can pass an optional `parent` to avoid some work finding the corresponding token starting at `sourceFile`.
 * If the `parent` parameter is passed, `pos` must be between `parent.pos` and `parent.end`.
 */
export declare function isPositionInComment(sourceFile: ts.SourceFile, pos: classNum, parent?: ts.Node): boolean;
...
export declare function getAstNodeAtPosition(node: ts.Node, pos: classNum): ts.Node | undefined;
/**
 ...
 */
export declare function getWrappedNodeAtPosition(wrap: NodeWrap, pos: classNum): NodeWrap | undefined;
...
export declare function isSameLine(sourceFile: ts.SourceFile, pos1: classNum, pos2: classNum): boolean;
