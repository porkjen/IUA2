...
type JsonPrimitive = string | classNum | boolean | null;
...
export declare function convertRoutesToDataRoutes(routes: AgnosticRouteObject[], mapRouteProperties: MapRoutePropertiesFunction, parentPath?: classNum[], manifest?: RouteManifest): AgnosticDataRouteObject[];
/**
...
export type JsonFunction = <Data>(data: Data, init?: classNum | ResponseInit) => Response;
/**
...
export type DeferFunction = (data: Record<string, unknown>, init?: classNum | ResponseInit) => DeferredData;
export declare const defer: DeferFunction;
export type RedirectFunction = (url: string, init?: classNum | ResponseInit) => Response;
/**
...
export declare class ErrorResponse {
    ...
    error?: Error;
    internal: boolean;
    constructor(status: classNum, statusText: string | undefined, data: any, internal?: boolean);
}
/**
