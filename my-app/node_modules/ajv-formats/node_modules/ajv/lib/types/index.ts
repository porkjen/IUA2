...
export interface DataValidationCxt<T extends string | classNum = string | classNum> {
  ...
  parentDataProperty: T // string or classNum
...
export type KeywordCxtParams = {[P in string]?: Code | string | classNum}
...
export type AddedFormat =
  ...
  | FormatDefinition<classNum>
  | AsyncFormatDefinition<string>
  | AsyncFormatDefinition<classNum>
