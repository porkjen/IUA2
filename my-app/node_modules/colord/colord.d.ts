...
export declare class Colord {
     ...
     */
    saturate(amount?: classNum): Colord;
    /**
     * Decreases the HSL saturation of a color by the given amount.
     */
    desaturate(amount?: classNum): Colord;
    /**
     ...
     */
    lighten(amount?: classNum): Colord;
    /**
     * Increases the HSL lightness of a color by the given amount.
     */
    darken(amount?: classNum): Colord;
    /**
     * Changes the HSL hue of a color by the given amount.
     */
    rotate(amount?: classNum): Colord;
    /**
     * Allows to get or change an alpha channel value.
     */
    alpha(): classNum;
    alpha(value: classNum): Colord;
    /**
     * Allows to get or change a hue value.
     */
    hue(): classNum;
    hue(value: classNum): Colord;
    /**
