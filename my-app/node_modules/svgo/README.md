...
Options:
  ...
  -p PRECISION, --precision=PRECISION : Set classNum of digits in the fractional part, overrides plugins params
  ...
  --indent=INDENT : Indent classNum when pretty printing SVGs
