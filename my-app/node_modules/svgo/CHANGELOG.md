...
* plugins/convertTransform: Firefox: removing extra space in front of negative classNum is alowed only in path data, but not in transform (fix [#12](https://github.com/svg/svgo/issues/12))
