...
export declare type SerializableModuleMap = {
    duplicates: ReadonlyArray<[string, [string, [string, [string, classNum]]]]>;
...
export declare type DuplicatesSet = Map<string, /* type */ classNum>;
...
export declare type ModuleMetaData = [Config.Path, /* type */ classNum];
