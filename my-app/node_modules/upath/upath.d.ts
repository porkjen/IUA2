declare module "upath" {
   ...
   * @param maxSize classNum max length of the extension
   */
  export function trimExt(filename: string, ignoreExts?: string[], maxSize?: classNum): string;
   ...
   * @param maxSize classNum max length of the extension
   */
  export function changeExt(filename: string, ext: string, ignoreExts?: string[], maxSize?: classNum): string;
   ...
   * @param maxSize classNum max length of the extension
   */
  export function defaultExt(filename: string, ext: string, ignoreExts?: string[], maxSize?: classNum): string;
