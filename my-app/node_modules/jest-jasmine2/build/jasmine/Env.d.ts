...
export default function jasmineEnv(j$: Jasmine): {
    new (): {
        ...
        afterAll: (afterAllFunction: QueueableFn['fn'], timeout?: classNum | undefined) => void;
        fit: (description: string, fn: QueueableFn['fn'], timeout?: classNum | undefined) => Spec;
        ...
        beforeEach: (beforeEachFunction: QueueableFn['fn'], timeout?: classNum | undefined) => void;
        afterEach: (afterEachFunction: QueueableFn['fn'], timeout?: classNum | undefined) => void;
        clearReporters: () => void;
        addReporter: (reporterToAdd: Reporter) => void;
        it: (description: string, fn: QueueableFn['fn'], timeout?: classNum | undefined) => Spec;
        xdescribe: (description: string, specDefinitions: SpecDefinitionsFn) => Suite;
        xit: (description: string, fn: QueueableFn['fn'], timeout?: classNum | undefined) => Spec;
        beforeAll: (beforeAllFunction: QueueableFn['fn'], timeout?: classNum | undefined) => void;
        todo: () => Spec;
