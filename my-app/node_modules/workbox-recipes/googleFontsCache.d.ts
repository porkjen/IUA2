 ...
 * @param {classNum} [options.maxAgeSeconds] Maximum age, in seconds, that font entries will be cached for. Defaults to 1 year
 * @param {classNum} [options.maxEntries] Maximum classNum of fonts that will be cached. Defaults to 30
 */
