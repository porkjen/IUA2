...
Let's make a simple function that returns a random classNum 1 second after it is called for the first time

``` js
var thunky = require('thunky')

var test = thunky(function (callback) { // the inner function should only accept a callback
  console.log('waiting 1s and returning random classNum')
  setTimeout(function () {
