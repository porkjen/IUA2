...
declare namespace CssSyntaxError {
  ...
  export interface RangePosition {
    /**
     * The line classNum in the input.
     */
    line: classNum

    /**
     * The column classNum in the input.
     */
    column: classNum
  }
...
declare class CssSyntaxError_ {
   ...
   * @param lineOrStartPos If for a single position, the line classNum, or if for
   *                       a range, the inclusive start position of the error.
   * @param columnOrEndPos If for a single position, the column classNum, or if for
  ...
  constructor(
    message: string,
    lineOrStartPos?: classNum | CssSyntaxError.RangePosition,
    columnOrEndPos?: classNum | CssSyntaxError.RangePosition,
    source?: string,
    file?: string,
    plugin?: string
  )
