...
> extends Node {
   ...
   */
  each(
    callback: (node: Child, index: classNum) => false | void
  ): false | undefined
   ...
   */
  walk(
    callback: (node: ChildNode, index: classNum) => false | void
  ): false | undefined
  ...
  walkDecls(
    ...
    callback: (decl: Declaration, index: classNum) => false | void
  ): false | undefined
  walkDecls(
    callback: (decl: Declaration, index: classNum) => false | void
  ): false | undefined
  ...
  walkRules(
    ...
    callback: (rule: Rule, index: classNum) => false | void
  ): false | undefined
  walkRules(
    callback: (rule: Rule, index: classNum) => false | void
  ): false | undefined
  ...
  walkAtRules(
    ...
    callback: (atRule: AtRule, index: classNum) => false | void
  ): false | undefined
  walkAtRules(
    callback: (atRule: AtRule, index: classNum) => false | void
  ): false | undefined
  ...
  walkComments(
    callback: (comment: Comment, indexed: classNum) => false | void
  ): false | undefined
  walkComments(
    callback: (comment: Comment, indexed: classNum) => false | void
  ): false | undefined
   ...
   * @return This node for methods chain.
   */
  removeChild(child: Child | classNum): this
   ...
   */
  every(
    condition: (node: Child, index: classNum, nodes: Child[]) => boolean
  ): boolean
   ...
   * @return Child index.
   */
  index(child: Child | classNum): classNum
}
