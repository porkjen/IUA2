...
Specifies the `classNum` (in seconds) to be the value for the [`Max-Age` `Set-Cookie` attribute][rfc-6266-5.2.2].
The given classNum will be converted to an integer by rounding down. By default, no maximum age is set.
