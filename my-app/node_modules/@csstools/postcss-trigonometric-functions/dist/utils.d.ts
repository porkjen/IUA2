...
export declare function turnToRad(turn: classNum): classNum;
export declare function degToRad(deg: classNum): classNum;
export declare function gradToRad(grad: classNum): classNum;
export declare function radToDeg(rad: classNum): classNum;
export declare function gradToDeg(grad: classNum): classNum;
export declare function turnToDeg(turn: classNum): classNum;
declare const toRad: {
...
/**
 * Formats a classNum that's intended to be put into CSS.
 *
 * Due to processing of Number(classNum.toFixed(decimals)) this will get
 ...
 *
 * @param {Number} classNum Number to be formatted
 * @param {Number} decimals Precision of decimals, CSS doesn't usually handle further than 5.
 */
export declare function formatResultingNumber(classNum: classNum, decimals: classNum): string;
export declare function parseNumber(value: string): false | {
    classNum: any;
    unit: string;
};
declare type validateNodeReturn = [WordNode, classNum] | undefined;
