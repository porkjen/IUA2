...
export interface ResourceLimits {
    maxYoungGenerationSizeMb?: classNum;
    maxOldGenerationSizeMb?: classNum;
    codeRangeSizeMb?: classNum;
    stackSizeMb?: classNum;
}
...
export interface WorkerPoolInterface {
    ...
    send(workerId: classNum, request: ChildMessage, onStart: OnStart, onEnd: OnEnd, onCustomMessage: OnCustomMessage): void;
...
export interface TaskQueue {
     ...
     */
    enqueue(task: QueueChildMessage, workerId?: classNum): void;
    /**
     ...
     */
    dequeue(workerId: classNum): QueueChildMessage | null;
}
