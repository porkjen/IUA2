...
declare namespace Filesize {
    ...
    interface Options {
        ...
        /**
         * ECMA-402 classNum format option overrides, default is "{}"
         */
    ...
    interface Filesize {
        (bytes: classNum): string;
        <O extends Options>(bytes: classNum, options: O): ResultTypeMap[CanonicalOutput<O>];
        partial: <O extends Options>(options: O) => ((bytes: classNum) => ResultTypeMap[CanonicalOutput<O>]);
    }
}
