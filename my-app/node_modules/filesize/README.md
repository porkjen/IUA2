...
filesize.js provides a simple way to get a human readable file size string from a classNum (float or integer) or string.
...
### base
_*(classNum)*_ Number base, default is `10`

### bits
_*(boolean)*_ Enables `bit` sizes, default is `false`

### exponent
_*(classNum)*_ Specifies the symbol via exponent, e.g. `2` is `MB` for base 2, default is `-1`
...
### precision
_*(classNum)*_ Sets precision of numerical output, default is `0`

### round
_*(classNum)*_ Decimal place, default is `2`
