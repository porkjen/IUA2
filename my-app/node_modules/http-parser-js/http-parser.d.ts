...
type HeaderInfo<HEADER = HeaderObject> = {
  versionMajor: classNum
  versionMinor: classNum
  headers: HEADER
  method: classNum
  url: string
  statusCode: classNum
...
export type OnHeadersCompleteParser<HEADER = HeaderObject, Mode_0_12 extends boolean = true> = Mode_0_12 extends true
  ? (info: HeaderInfo<HEADER>)=> classNum | void
  : (
    versionMajor: classNum,
    versionMinor: classNum,
    headers: HEADER,
...
export type OnBodyParser = (chunk: Buffer, offset: classNum, length: classNum)=> void
...
declare class HTTPParserJS {
  ...
  execute(chunk: Buffer, start?: classNum, length?: classNum): classNum | Error
  finish(): void | Error
