...
interface PluginUtils {
  ...
  rgb(arg: string): (arg: Partial<{ opacityVariable: string; opacityValue: classNum }>) => string
  hsl(arg: string): (arg: Partial<{ opacityVariable: string; opacityValue: classNum }>) => string
}
