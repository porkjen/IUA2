...
export interface PluginContext extends MinimalPluginContext {
	...
	emitChunk: EmitChunk;
	emitFile: EmitFile;
	error: (err: RollupError | string, pos?: classNum | { column: classNum; line: classNum }) => never;
	...
	warn: (warning: RollupWarning | string, pos?: classNum | { column: classNum; line: classNum }) => void;
}
...
export interface InputOptions {
	...
	context?: string;
	experimentalCacheExpiry?: classNum;
	...
	maxParallelFileOps?: classNum;
	/** @deprecated Use the "maxParallelFileOps" option instead. */
	maxParallelFileReads?: classNum;
...
export interface SerializedTimings {
	[label: string]: [classNum, classNum, classNum];
}
...
export interface RenderedModule {
	code: string | null;
	originalLength: classNum;
	removedExports: string[];
	renderedExports: string[];
	renderedLength: classNum;
}
...
export interface ChokidarOptions {
	alwaysStat?: boolean;
	atomic?: boolean | classNum;
	awaitWriteFinish?:
		| {
				pollInterval?: classNum;
				stabilityThreshold?: classNum;
		  }
		| boolean;
	binaryInterval?: classNum;
	cwd?: string;
	depth?: classNum;
...
interface TypedEventEmitter<T extends { [event: string]: (...args: any) => any }> {
	...
	listenerCount(type: keyof T): classNum;
