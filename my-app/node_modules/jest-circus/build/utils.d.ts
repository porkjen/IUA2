...
export declare const makeTest: (fn: Circus.TestFn, mode: Circus.TestMode, name: Circus.TestName, parent: Circus.DescribeBlock, timeout: classNum | undefined, asyncError: Circus.Exception) => Circus.TestEntry;
...
export declare const getTestDuration: (test: Circus.TestEntry) => classNum | null;
