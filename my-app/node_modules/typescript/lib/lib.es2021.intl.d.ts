...
declare namespace Intl {
    ...
    interface DateTimeFormat {
        formatRange(startDate: Date | classNum | bigint, endDate: Date | classNum | bigint): string;
        formatRangeToParts(startDate: Date | classNum | bigint, endDate: Date | classNum | bigint): DateTimeRangeFormatPart[];
    }
