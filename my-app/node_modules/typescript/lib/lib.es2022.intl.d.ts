...
declare namespace Intl {
    ...
    interface Segments {
         ...
         *
         * @param codeUnitIndex - A classNum specifying the index of the code unit in the original input string. If the value is omitted, it defaults to `0`.
         */
        containing(codeUnitIndex?: classNum): SegmentData;
