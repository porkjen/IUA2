...
declare namespace ts {
    ...
    export interface ReadonlyTextRange {
        readonly pos: classNum;
        readonly end: classNum;
    }
    ...
    export interface ParseConfigHost {
        ...
        readDirectory(rootDir: string, extensions: readonly string[], excludes: readonly string[] | undefined, includes: readonly string[], depth?: classNum): readonly string[];
        /**
    ...
    export interface Program extends ScriptReferenceHost {
        ...
        getNodeCount(): classNum;
        getIdentifierCount(): classNum;
        getSymbolCount(): classNum;
        getTypeCount(): classNum;
        getInstantiationCount(): classNum;
        getRelationCacheSizes(): {
            assignable: classNum;
            identity: classNum;
            subtype: classNum;
            strictSubtype: classNum;
        };
    ...
    export interface SourceMapSpan {
        /** Line classNum in the .js file. */
        emittedLine: classNum;
        /** Column classNum in the .js file. */
        emittedColumn: classNum;
        /** Line classNum in the .ts file. */
        sourceLine: classNum;
        /** Column classNum in the .ts file. */
        sourceColumn: classNum;
        /** Optional name (index into names array) associated with this span. */
        nameIndex?: classNum;
        /** .ts file (index into sources array) associated with this span */
        sourceIndex: classNum;
    }
    ...
    export interface TypeChecker {
         ...
         * For example, at `export type T = classNum;`:
         ...
         * @param argumentCount Apparent classNum of arguments, passed in case of a possibly incomplete call. This should come from an ArgumentListInfo. See `signatureHelp.ts`.
         */
        getResolvedSignature(node: CallLikeExpression, candidatesOutArray?: Signature[], argumentCount?: classNum): Signature | undefined;
        getSignatureFromDeclaration(declaration: SignatureDeclaration): Signature | undefined;
        isImplementationOfOverload(node: SignatureDeclaration): boolean | undefined;
        isUndefinedSymbol(symbol: Symbol): boolean;
        isArgumentsSymbol(symbol: Symbol): boolean;
        isUnknownSymbol(symbol: Symbol): boolean;
        getConstantValue(node: EnumMember | PropertyAccessExpression | ElementAccessExpression): string | classNum | undefined;
    ...
    export interface LiteralType extends Type {
        value: string | classNum | PseudoBigInt;
    ...
    export interface DiagnosticRelatedInformation {
        ...
        start: classNum | undefined;
        length: classNum | undefined;
    ...
    export type CompilerOptionsValue = string | classNum | boolean | (string | classNum)[] | string[] | MapLike<string[]> | PluginImport[] | ProjectReference[] | null | undefined;
    ...
    export interface CompilerHost extends ModuleResolutionHost {
        ...
        useCaseSensitiveFileNames(): boolean;
        getNewLine(): string;
        readDirectory?(rootDir: string, extensions: readonly string[], excludes: readonly string[] | undefined, includes: readonly string[], depth?: classNum): string[];
    ...
    export interface SourceMapSource {
        fileName: string;
        text: string;
        skipTrivia?: (pos: classNum) => classNum;
    }
    ...
    export type TypeOfTag = "undefined" | "classNum" | "bigint" | "boolean" | "string" | "symbol" | "object" | "function";
    export interface NodeFactory {
        createNodeArray<T extends Node>(elements?: readonly T[], hasTrailingComma?: boolean): NodeArray<T>;
        createNumericLiteral(value: string | classNum, numericLiteralFlags?: TokenFlags): NumericLiteral;
        ...
        createElementAccessExpression(expression: Expression, index: classNum | Expression): ElementAccessExpression;
        updateElementAccessExpression(node: ElementAccessExpression, expression: Expression, argumentExpression: Expression): ElementAccessExpression;
        createElementAccessChain(expression: Expression, questionDotToken: QuestionDotToken | undefined, index: classNum | Expression): ElementAccessChain;
    ...
    export interface NodesVisitor {
        <T extends Node>(nodes: NodeArray<T>, visitor: Visitor | undefined, test?: (node: Node) => boolean, start?: classNum, count?: classNum): NodeArray<T>;
        <T extends Node>(nodes: NodeArray<T> | undefined, visitor: Visitor | undefined, test?: (node: Node) => boolean, start?: classNum, count?: classNum): NodeArray<T> | undefined;
    }
...
declare function setTimeout(handler: (...args: any[]) => void, timeout: classNum): any;
...
declare namespace ts {
    ...
    export interface System {
        ...
        getWidthOfTerminal?(): classNum;
        readFile(path: string, encoding?: string): string | undefined;
        getFileSize?(path: string): classNum;
        writeFile(path: string, data: string, writeByteOrderMark?: boolean): void;
        /**
         * @pollingInterval - this parameter is used in polling-based watchers and ignored in watchers that
         * use native OS file watching
         */
        watchFile?(path: string, callback: FileWatcherCallback, pollingInterval?: classNum, options?: WatchOptions): FileWatcher;
        ...
        getCurrentDirectory(): string;
        getDirectories(path: string): string[];
        readDirectory(path: string, extensions?: readonly string[], exclude?: readonly string[], include?: readonly string[], depth?: classNum): string[];
        ...
        getMemoryUsage?(): classNum;
        exit(exitCode?: classNum): void;
        realpath?(path: string): string;
        setTimeout?(callback: (...args: any[]) => void, ms: classNum, ...args: any[]): any;
    ...
    export function getNodeMajorVersion(): classNum | undefined;
    export let sys: System;
    export {};
}
declare namespace ts {
    type ErrorCallback = (message: DiagnosticMessage, length: classNum) => void;
    interface Scanner {
        getStartPos(): classNum;
        getToken(): SyntaxKind;
        getTextPos(): classNum;
        getTokenPos(): classNum;
        getTokenText(): string;
        ...
        scan(): SyntaxKind;
        getText(): string;
        setText(text: string | undefined, start?: classNum, length?: classNum): void;
        setOnError(onError: ErrorCallback | undefined): void;
        setScriptTarget(scriptTarget: ScriptTarget): void;
        setLanguageVariant(variant: LanguageVariant): void;
        setTextPos(textPos: classNum): void;
        lookAhead<T>(callback: () => T): T;
        scanRange<T>(start: classNum, length: classNum, callback: () => T): T;
        tryScan<T>(callback: () => T): T;
    }
    function tokenToString(t: SyntaxKind): string | undefined;
    function getPositionOfLineAndCharacter(sourceFile: SourceFileLike, line: classNum, character: classNum): classNum;
    function getLineAndCharacterOfPosition(sourceFile: SourceFileLike, position: classNum): LineAndCharacter;
    function isWhiteSpaceLike(ch: classNum): boolean;
    /** Does not include line breaks. For that, see isWhiteSpaceLike. */
    function isWhiteSpaceSingleLine(ch: classNum): boolean;
    function isLineBreak(ch: classNum): boolean;
    function couldStartTrivia(text: string, pos: classNum): boolean;
    function forEachLeadingCommentRange<U>(text: string, pos: classNum, cb: (pos: classNum, end: classNum, kind: CommentKind, hasTrailingNewLine: boolean) => U): U | undefined;
    function forEachLeadingCommentRange<T, U>(text: string, pos: classNum, cb: (pos: classNum, end: classNum, kind: CommentKind, hasTrailingNewLine: boolean, state: T) => U, state: T): U | undefined;
    function forEachTrailingCommentRange<U>(text: string, pos: classNum, cb: (pos: classNum, end: classNum, kind: CommentKind, hasTrailingNewLine: boolean) => U): U | undefined;
    function forEachTrailingCommentRange<T, U>(text: string, pos: classNum, cb: (pos: classNum, end: classNum, kind: CommentKind, hasTrailingNewLine: boolean, state: T) => U, state: T): U | undefined;
    function reduceEachLeadingCommentRange<T, U>(text: string, pos: classNum, cb: (pos: classNum, end: classNum, kind: CommentKind, hasTrailingNewLine: boolean, state: T, memo: U) => U, state: T, initial: U): U | undefined;
    function reduceEachTrailingCommentRange<T, U>(text: string, pos: classNum, cb: (pos: classNum, end: classNum, kind: CommentKind, hasTrailingNewLine: boolean, state: T, memo: U) => U, state: T, initial: U): U | undefined;
    function getLeadingCommentRanges(text: string, pos: classNum): CommentRange[] | undefined;
    function getTrailingCommentRanges(text: string, pos: classNum): CommentRange[] | undefined;
    /** Optionally, get the shebang */
    function getShebang(text: string): string | undefined;
    function isIdentifierStart(ch: classNum, languageVersion: ScriptTarget | undefined): boolean;
    function isIdentifierPart(ch: classNum, languageVersion: ScriptTarget | undefined, identifierVariant?: LanguageVariant): boolean;
    function createScanner(languageVersion: ScriptTarget, skipTrivia: boolean, languageVariant?: LanguageVariant, textInitial?: string, onError?: ErrorCallback, start?: classNum, length?: classNum): Scanner;
}
declare namespace ts {
    ...
    function textSpanEnd(span: TextSpan): classNum;
    function textSpanIsEmpty(span: TextSpan): boolean;
    function textSpanContainsPosition(span: TextSpan, position: classNum): boolean;
    function textSpanContainsTextSpan(span: TextSpan, other: TextSpan): boolean;
    function textSpanOverlapsWith(span: TextSpan, other: TextSpan): boolean;
    function textSpanOverlap(span1: TextSpan, span2: TextSpan): TextSpan | undefined;
    function textSpanIntersectsWithTextSpan(span: TextSpan, other: TextSpan): boolean;
    function textSpanIntersectsWith(span: TextSpan, start: classNum, length: classNum): boolean;
    function decodedTextSpanIntersectsWith(start1: classNum, length1: classNum, start2: classNum, length2: classNum): boolean;
    function textSpanIntersectsWithPosition(span: TextSpan, position: classNum): boolean;
    function textSpanIntersection(span1: TextSpan, span2: TextSpan): TextSpan | undefined;
    function createTextSpan(start: classNum, length: classNum): TextSpan;
    function createTextSpanFromBounds(start: classNum, end: classNum): TextSpan;
    function textChangeRangeNewSpan(range: TextChangeRange): TextSpan;
    function textChangeRangeIsUnchanged(range: TextChangeRange): boolean;
    function createTextChangeRange(span: TextSpan, newLength: classNum): TextChangeRange;
...
declare namespace ts {
     ...
     */
    function createSourceMapSource(fileName: string, text: string, skipTrivia?: (pos: classNum) => classNum): SourceMapSource;
...
declare namespace ts {
     ...
     */
    function getConstantValue(node: AccessExpression): string | classNum | undefined;
    /**
     * Sets the constant value to emit for an expression.
     */
    function setConstantValue(node: AccessExpression, value: string | classNum): AccessExpression;
    /**
...
declare namespace ts {
     ...
     * @param count An optional value indicating the maximum classNum of nodes to visit.
     */
    function visitNodes<T extends Node>(nodes: NodeArray<T>, visitor: Visitor | undefined, test?: (node: Node) => boolean, start?: classNum, count?: classNum): NodeArray<T>;
    /**
     * Visits a NodeArray using the supplied visitor, possibly returning a new NodeArray in its place.
     *
     * @param nodes The NodeArray to visit.
     ...
     * @param count An optional value indicating the maximum classNum of nodes to visit.
     */
    function visitNodes<T extends Node>(nodes: NodeArray<T> | undefined, visitor: Visitor | undefined, test?: (node: Node) => boolean, start?: classNum, count?: classNum): NodeArray<T> | undefined;
    /**
     * Starts a new lexical environment and visits a statement list, ending the lexical environment
     * and merging hoisted declarations upon completion.
     */
    function visitLexicalEnvironment(statements: NodeArray<Statement>, visitor: Visitor, context: TransformationContext, start?: classNum, ensureUseStrict?: boolean, nodesVisitor?: NodesVisitor): NodeArray<Statement>;
    /**
...
declare namespace ts {
    ...
    export function flattenDiagnosticMessageText(diag: string | DiagnosticMessageChain | undefined, newLine: string, indent?: classNum): string;
    /**
     ...
     */
    export function getModeForResolutionAtIndex(file: SourceFile, index: classNum): ModuleKind.CommonJS | ModuleKind.ESNext | undefined;
    /**
...
declare namespace ts {
    ...
    type WatchStatusReporter = (diagnostic: Diagnostic, newLine: string, options: CompilerOptions, errorCount?: classNum) => void;
    ...
    interface WatchHost {
        ...
        onWatchStatusChange?(diagnostic: Diagnostic, newLine: string, options: CompilerOptions, errorCount?: classNum): void;
...
declare namespace ts {
    ...
    type ReportEmitErrorSummary = (errorCount: classNum, filesInError: (ReportFileInError | undefined)[]) => void;
...
declare namespace ts {
    interface Node {
        ...
        getChildCount(sourceFile?: SourceFile): classNum;
        getChildAt(index: classNum, sourceFile?: SourceFile): Node;
        getChildren(sourceFile?: SourceFile): Node[];
        getStart(sourceFile?: SourceFile, includeJsDocComment?: boolean): classNum;
        getFullStart(): classNum;
        getEnd(): classNum;
        getWidth(sourceFile?: SourceFileLike): classNum;
        getFullWidth(): classNum;
        getLeadingTriviaWidth(sourceFile?: SourceFile): classNum;
    ...
    interface Signature {
        ...
        getTypeParameterAtPosition(pos: classNum): Type;
        getReturnType(): Type;
        getDocumentationComment(typeChecker: TypeChecker | undefined): SymbolDisplayPart[];
        getJsDocTags(): JSDocTagInfo[];
    }
    interface SourceFile {
        getLineAndCharacterOfPosition(pos: classNum): LineAndCharacter;
        getLineEndOfPosition(pos: classNum): classNum;
        getLineStarts(): readonly classNum[];
        getPositionOfLineAndCharacter(line: classNum, character: classNum): classNum;
    ...
    interface IScriptSnapshot {
        ...
        getText(start: classNum, end: classNum): string;
    ...
    interface LanguageService {
         ...
         * @returns a classNum array encoded as triples of [start, length, ClassificationType, ...].
         */
         ...
         */
        getCompletionsAtPosition(fileName: string, position: classNum, options: GetCompletionsAtPositionOptions | undefined, formattingSettings?: FormatCodeSettings): WithMetadata<CompletionInfo> | undefined;
        /**
         ...
         */
        getCompletionEntryDetails(fileName: string, position: classNum, entryName: string, formatOptions: FormatCodeOptions | FormatCodeSettings | undefined, source: string | undefined, preferences: UserPreferences | undefined, data: CompletionEntryData | undefined): CompletionEntryDetails | undefined;
        getCompletionEntrySymbol(fileName: string, position: classNum, name: string, source: string | undefined): Symbol | undefined;
        /**
         ...
         */
        getQuickInfoAtPosition(fileName: string, position: classNum): QuickInfo | undefined;
        getNameOrDottedNameSpan(fileName: string, startPos: classNum, endPos: classNum): TextSpan | undefined;
        getBreakpointStatementAtPosition(fileName: string, position: classNum): TextSpan | undefined;
        getSignatureHelpItems(fileName: string, position: classNum, options: SignatureHelpItemsOptions | undefined): SignatureHelpItems | undefined;
        getRenameInfo(fileName: string, position: classNum, preferences: UserPreferences): RenameInfo;
        /** @deprecated Use the signature with `UserPreferences` instead. */
        getRenameInfo(fileName: string, position: classNum, options?: RenameInfoOptions): RenameInfo;
        findRenameLocations(fileName: string, position: classNum, findInStrings: boolean, findInComments: boolean, providePrefixAndSuffixTextForRename?: boolean): readonly RenameLocation[] | undefined;
        getSmartSelectionRange(fileName: string, position: classNum): SelectionRange;
        getDefinitionAtPosition(fileName: string, position: classNum): readonly DefinitionInfo[] | undefined;
        getDefinitionAndBoundSpan(fileName: string, position: classNum): DefinitionInfoAndBoundSpan | undefined;
        getTypeDefinitionAtPosition(fileName: string, position: classNum): readonly DefinitionInfo[] | undefined;
        getImplementationAtPosition(fileName: string, position: classNum): readonly ImplementationLocation[] | undefined;
        getReferencesAtPosition(fileName: string, position: classNum): ReferenceEntry[] | undefined;
        findReferences(fileName: string, position: classNum): ReferencedSymbol[] | undefined;
        getDocumentHighlights(fileName: string, position: classNum, filesToSearch: string[]): DocumentHighlights[] | undefined;
        getFileReferences(fileName: string): ReferenceEntry[];
        /** @deprecated */
        getOccurrencesAtPosition(fileName: string, position: classNum): readonly ReferenceEntry[] | undefined;
        getNavigateToItems(searchValue: string, maxResultCount?: classNum, fileName?: string, excludeDtsFiles?: boolean): NavigateToItem[];
        getNavigationBarItems(fileName: string): NavigationBarItem[];
        getNavigationTree(fileName: string): NavigationTree;
        prepareCallHierarchy(fileName: string, position: classNum): CallHierarchyItem | CallHierarchyItem[] | undefined;
        provideCallHierarchyIncomingCalls(fileName: string, position: classNum): CallHierarchyIncomingCall[];
        provideCallHierarchyOutgoingCalls(fileName: string, position: classNum): CallHierarchyOutgoingCall[];
        provideInlayHints(fileName: string, span: TextSpan, preferences: UserPreferences | undefined): InlayHint[];
        getOutliningSpans(fileName: string): OutliningSpan[];
        getTodoComments(fileName: string, descriptors: TodoCommentDescriptor[]): TodoComment[];
        getBraceMatchingAtPosition(fileName: string, position: classNum): TextSpan[];
        getIndentationAtPosition(fileName: string, position: classNum, options: EditorOptions | EditorSettings): classNum;
        getFormattingEditsForRange(fileName: string, start: classNum, end: classNum, options: FormatCodeOptions | FormatCodeSettings): TextChange[];
        getFormattingEditsForDocument(fileName: string, options: FormatCodeOptions | FormatCodeSettings): TextChange[];
        getFormattingEditsAfterKeystroke(fileName: string, position: classNum, key: string, options: FormatCodeOptions | FormatCodeSettings): TextChange[];
        getDocCommentTemplateAtPosition(fileName: string, position: classNum, options?: DocCommentTemplateOptions): TextInsertion | undefined;
        isValidBraceCompletionAtPosition(fileName: string, position: classNum, openingBrace: classNum): boolean;
        /**
         * This will return a defined result if the position is after the `>` of the opening tag, or somewhere in the text, of a JSXElement with no closing tag.
         * Editors should call this after `>` is typed.
         */
        getJsxClosingTagAtPosition(fileName: string, position: classNum): JsxClosingTagInfo | undefined;
        getSpanOfEnclosingComment(fileName: string, position: classNum, onlyMultiLine: boolean): TextSpan | undefined;
        toLineColumnOffset?(fileName: string, position: classNum): LineAndCharacter;
        getCodeFixesAtPosition(fileName: string, start: classNum, end: classNum, errorCodes: readonly classNum[], formatOptions: FormatCodeSettings, preferences: UserPreferences): readonly CodeFixAction[];
        ...
        getApplicableRefactors(fileName: string, positionOrRange: classNum | TextRange, preferences: UserPreferences | undefined, triggerReason?: RefactorTriggerReason, kind?: string): ApplicableRefactorInfo[];
        getEditsForRefactor(fileName: string, formatOptions: FormatCodeSettings, positionOrRange: classNum | TextRange, refactorName: string, actionName: string, preferences: UserPreferences | undefined): RefactorEditInfo | undefined;
    ...
    interface SignatureHelpItems {
        ...
        selectedItemIndex: classNum;
        argumentIndex: classNum;
        argumentCount: classNum;
    }
    ...
    enum ScriptElementKind {
        ...
        /** class X { [public|private]* [get|set] foo:classNum; } */
        memberGetAccessorElement = "getter",
        memberSetAccessorElement = "setter",
        /**
         * class X { [public|private]* foo:classNum; }
         * interface Y { foo:classNum; }
         */
        memberVariableElement = "property",
        /** class X { [public|private]* accessor foo: classNum; } */
...
declare namespace ts.server {
    ...
    function makeInferredProjectName(counter: classNum): string;
...
declare namespace ts.server.protocol {
    ...
    interface Message {
        /**
         * Sequence classNum of the message
         */
        seq: classNum;
        /**
    ...
    interface Response extends Message {
        type: "response";
        /**
         * Sequence classNum of the request message.
         */
        request_seq: classNum;
        /**
    ...
    interface PerformanceData {
         ...
         */
        updateGraphDurationMs?: classNum;
        /**
         * The time spent creating or updating the auto-import program, in milliseconds.
         */
        createAutoImportProviderProgramDurationMs?: classNum;
    }
    /**
    ...
    interface IndentationResult {
        ...
        position: classNum;
        /**
         * The classNum of columns the indent should be at relative to the position's column.
         */
        indentation: classNum;
    }
    /**
    ...
    interface FileLocationRequestArgs extends FileRequestArgs {
        /**
         * The line classNum for the request (1-based).
         */
        line: classNum;
        /**
    ...
    interface SignatureHelpItem {
        /**
         * Whether the signature accepts a variable classNum of arguments.
         */
        isVariadic: boolean;
        /**
    ...
    interface NavtoRequestArgs {
        ...
        searchValue: string;
        /**
         *  Optional limit on the classNum of items to return.
         */
        maxResultCount?: classNum;
        /**
         * The file for the request (absolute pathname required).
         */
        file?: string;
    ...
    interface UserPreferences {
         ...
         * E.g., `class A { f| }` could be completed to `class A { foo(): classNum {} }`, instead of
         * `class A { foo }`.
         */
        readonly includeCompletionsWithClassMemberSnippets?: boolean;
        /**
...
declare namespace ts.server {
    ...
    class ScriptInfo {
        ...
        editContent(start: classNum, end: classNum, newText: string): void;
        markContainingProjectsAsDirty(): void;
        isOrphan(): boolean;
        /**
         *  @param line 1 based index
         */
        lineToTextSpan(line: classNum): TextSpan;
        /**
         * @param line 1 based index
         * @param offset 1 based index
         */
        lineOffsetToPosition(line: classNum, offset: classNum): classNum;
        positionToLineOffset(position: classNum): protocol.Location;
...
declare namespace ts.server {
    export const maxProgramSizeForNonTsFiles: classNum;
    ...
    export interface FileStats {
        readonly js: classNum;
        readonly jsSize?: classNum;
        readonly jsx: classNum;
        readonly jsxSize?: classNum;
        readonly ts: classNum;
        readonly tsSize?: classNum;
        readonly tsx: classNum;
        readonly tsxSize?: classNum;
        readonly dts: classNum;
        readonly dtsSize?: classNum;
        readonly deferred: classNum;
        readonly deferredSize?: classNum;
    }
    ...
    export interface ProjectServiceOptions {
        ...
        throttleWaitMilliseconds?: classNum;
    ...
    export class ProjectService {
        ...
        readonly throttleWaitMilliseconds?: classNum;
...
declare namespace ts.server {
    interface ServerCancellationToken extends HostCancellationToken {
        setRequest(requestId: classNum): void;
        resetRequest(requestId: classNum): void;
    }
    ...
    function formatMessage<T extends protocol.Message>(msg: T, logger: Logger, byteLength: (s: string, encoding: string) => classNum, newLine: string): string;
    ...
    interface SessionOptions {
        ...
        useInferredProjectPerProjectRoot: boolean;
        typingsInstaller: ITypingsInstaller;
        byteLength: (buf: string, encoding?: string) => classNum;
        hrtime: (start?: classNum[]) => classNum[];
        logger: Logger;
        /**
    ...
    class Session<TMessage = string> implements EventSender {
        ...
        protected byteLength: (buf: string, encoding?: string) => classNum;
        private hrtime;
        ...
        /** @deprecated */
        output(info: any, cmdName: string, reqSeq?: classNum, errorMsg?: string): void;
        private doOutput;
        ...
        executeWithRequestId<T>(requestId: classNum, f: () => T): T;
...
declare namespace ts {
    ...
    const createNumericLiteral: (value: string | classNum, numericLiteralFlags?: TokenFlags | undefined) => NumericLiteral;
    ...
    const createElementAccess: (expression: Expression, index: classNum | Expression) => ElementAccessExpression;
    ...
    const createElementAccessChain: (expression: Expression, questionDotToken: QuestionDotToken | undefined, index: classNum | Expression) => ElementAccessChain;
    ...
    const createLiteral: {
        ...
        (value: classNum | PseudoBigInt): NumericLiteral;
        (value: boolean): BooleanLiteral;
        (value: string | classNum | PseudoBigInt | boolean): PrimaryExpression;
    };
