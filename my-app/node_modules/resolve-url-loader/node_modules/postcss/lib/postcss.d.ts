...
declare namespace postcss {
  ...
  interface Input {
     ...
     */
    origin(line: classNum, column: classNum): InputOrigin | false;
  }
  ...
  interface ContainerBase extends NodeBase {
     ...
     */
    index(child: ChildNode | classNum): classNum;
    /**
     ...
     * children.
     */
    every(callback: (node: ChildNode, index: classNum, nodes: ChildNode[]) => boolean): boolean;
    /**
     ...
     */
    some(callback: (node: ChildNode, index: classNum, nodes: ChildNode[]) => boolean): boolean;
    /**
     ...
     */
    each(callback: (node: ChildNode, index: classNum) => void): void;
    each(callback: (node: ChildNode, index: classNum) => boolean): boolean;
    /**
     ...
     */
    walk(callback: (node: ChildNode, index: classNum) => void): void;
    walk(callback: (node: ChildNode, index: classNum) => boolean): boolean;
    /**
     * Traverses the container's descendant nodes, calling `callback` for each
     ...
     */
    walkDecls(propFilter: string | RegExp, callback: (decl: Declaration, index: classNum) => void): void;
    walkDecls(callback: (decl: Declaration, index: classNum) => void): void;
    walkDecls(propFilter: string | RegExp, callback: (decl: Declaration, index: classNum) => boolean): boolean;
    walkDecls(callback: (decl: Declaration, index: classNum) => boolean): boolean;
    /**
     * Traverses the container's descendant nodes, calling `callback` for each
     ...
     * container.
     */
    walkAtRules(nameFilter: string | RegExp, callback: (atRule: AtRule, index: classNum) => void): void;
    walkAtRules(callback: (atRule: AtRule, index: classNum) => void): void;
    walkAtRules(nameFilter: string | RegExp, callback: (atRule: AtRule, index: classNum) => boolean): boolean;
    walkAtRules(callback: (atRule: AtRule, index: classNum) => boolean): boolean;
    /**
     * Traverses the container's descendant nodes, calling `callback` for each
     ...
     * container.
     */
    walkRules(selectorFilter: string | RegExp, callback: (atRule: Rule, index: classNum) => void): void;
    walkRules(callback: (atRule: Rule, index: classNum) => void): void;
    walkRules(selectorFilter: string | RegExp, callback: (atRule: Rule, index: classNum) => boolean): boolean;
    walkRules(callback: (atRule: Rule, index: classNum) => boolean): boolean;
    /**
     * Traverses the container's descendant nodes, calling `callback` for each
     ...
     */
    walkComments(callback: (comment: Comment, indexed: classNum) => void): void;
    walkComments(callback: (comment: Comment, indexed: classNum) => boolean): boolean;
    /**
     ...
     * @returns This container for chaining.
     */
    insertBefore(oldNode: ChildNode | classNum, newNode: ChildNode | object | string): this;
    /**
     * Insert newNode after oldNode within the container.
     * @param oldNode Child or child's index.
     * @returns This container for chaining.
     */
    insertAfter(oldNode: ChildNode | classNum, newNode: ChildNode | object | string): this;
    /**
     ...
     * @returns This container for chaining.
     */
    removeChild(child: ChildNode | classNum): this;
    /**
