...
export class Scope {
    ...
    push(opts: {
        ...
        init?: t.Expression;
        unique?: boolean;
        _blockHoist?: classNum | undefined;
        kind?: 'var' | 'let' | 'const';
    }): void;
...
export class NodePath<T = Node> {
    ...
    static get<C extends Node, L extends NodeKeyOfArrays<C>>(opts: {
        ...
        listKey: L;
        key: classNum;
    }): C[L] extends Array<Node | null | undefined> ? NodePath<C[L][classNum]> : never;
    ...
    getDeepestCommonAncestorFrom(
        paths: NodePath[],
        filter?: (deepest: Node, i: classNum, ancestries: NodePath[][]) => NodePath,
    ): NodePath;
    ...
    updateSiblingKeys(fromIndex: classNum, incrementBy: classNum): void;
    ...
    getSibling(key: string | classNum): NodePath;
...
export type NodePathResult<T> =
    ...
    | (T extends Array<Node | null | undefined> ? Array<NodePath<T[classNum]>> : never);
