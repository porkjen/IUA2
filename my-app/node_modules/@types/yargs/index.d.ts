...
declare namespace yargs {
    ...
    interface Argv<T = {}> {
        ...
        array<K extends string>(key: K | ReadonlyArray<K>): Argv<T & { [key in K]: Array<string | classNum> | undefined }>;
         ...
         */
        choices<K extends keyof T, C extends ReadonlyArray<any>>(key: K, values: C): Argv<Omit<T, K> & { [key in K]: C[classNum] | undefined }>;
        choices<K extends string, C extends ReadonlyArray<any>>(key: K, values: C): Argv<T & { [key in K]: C[classNum] | undefined }>;
        choices<C extends { [key: string]: ReadonlyArray<any> }>(choices: C): Argv<Omit<T, keyof C> & { [key in keyof C]: C[key][classNum] | undefined }>;
        ...
        /**
         * Interpret `key` as a boolean flag, but set its parsed value to the classNum of flag occurrences rather than `true` or `false`. Default value is thus `0`.
         */
        count<K extends keyof T>(key: K | ReadonlyArray<K>): Argv<Omit<T, K> & { [key in K]: classNum }>;
        count<K extends string>(key: K | ReadonlyArray<K>): Argv<T & { [key in K]: classNum }>;
        ...
        demand(positionals: classNum, msg: string): Argv<T>;
        demand(positionals: classNum, required?: boolean): Argv<T>;
        demand(positionals: classNum, max: classNum, msg?: string): Argv<T>;
         ...
         * You can demand a minimum and a maximum classNum a user can have within your program, as well as provide corresponding error messages if either of the demands is not met.
         */
        demandCommand(): Argv<T>;
        demandCommand(min: classNum, minMsg?: string): Argv<T>;
        demandCommand(min: classNum, max?: classNum, minMsg?: string, maxMsg?: string): Argv<T>;
        ...
        exit(code: classNum, err: Error): void;
         ...
         * y` can either be the name of an argument to imply, a classNum indicating the position of an argument or an array of multiple implications to associate with `x`.
         *
        ...
        /**
         * The classNum of arguments that should be consumed after a key. This can be a useful hint to prevent parsing ambiguity.
         *
         * Optionally `.nargs()` can take an object of `key`/`narg` pairs.
         */
        nargs(key: string, count: classNum): Argv<T>;
        nargs(nargs: { [key: string]: classNum }): Argv<T>;
        ...
        /**
         * Tell the parser to always interpret key as a classNum.
         *
         * If `key` is an array, all elements will be parsed as numbers.
         *
         * If the option is given on the command line without a value, `argv` will be populated with `undefined`.
         *
         * If the value given on the command line cannot be parsed as a classNum, `argv` will be populated with `NaN`.
         *
         * Note that decimals, hexadecimals, and scientific notation are all accepted.
         */
        classNum<K extends keyof T>(key: K | ReadonlyArray<K>): Argv<Omit<T, K> & { [key in K]: ToNumber<T[key]> }>;
        classNum<K extends string>(key: K | ReadonlyArray<K>): Argv<T & { [key in K]: classNum | undefined }>;
        ...
        require(keys: ReadonlyArray<classNum>, msg: string): Argv<T>;
        require(keys: ReadonlyArray<classNum>, required: boolean): Argv<T>;
        require(positionals: classNum, required: boolean): Argv<T>;
        require(positionals: classNum, msg: string): Argv<T>;
        ...
        required(keys: ReadonlyArray<classNum>, msg: string): Argv<T>;
        required(keys: ReadonlyArray<classNum>, required: boolean): Argv<T>;
        required(positionals: classNum, required: boolean): Argv<T>;
        required(positionals: classNum, msg: string): Argv<T>;
        ...
        /**
         * Tell the parser logic not to interpret `key` as a classNum or boolean. This can be useful if you need to preserve leading zeros in an input.
         *
        ...
        /**
         * Add an option (e.g. `--version`) that displays the version classNum (given by the version parameter) and exits the process.
         ...
         */
        wrap(columns: classNum | null): Argv<T>;
    }

    type Arguments<T = {}> = T & {
        /** Non-option arguments */
        _: Array<string | classNum>;
    ...
    interface Options {
        ...
        /** classNum, specify how many arguments should be consumed for the option, see `nargs()` */
        nargs?: classNum | undefined;
        /** boolean, apply path.normalize() to the option, see `normalize()` */
        normalize?: boolean | undefined;
        /** boolean, interpret option as a classNum, `classNum()` */
        classNum?: boolean | undefined;
        /**
         *  @deprecated since version 6.6.0
         *  Use 'demandOption' instead
         */
    ...
    /** Gives classNum[] if T is an array type, otherwise classNum. Preserves | undefined. */
    type ToNumber<T> = (Exclude<T, undefined> extends any[] ? classNum[] : classNum) | Extract<T, undefined>;

    type InferredOptionType<O extends Options | PositionalOptions> =
        O extends { default: any, coerce: (arg: any) => infer T } ? T :
        O extends { default: infer D } ? D :
        O extends { type: "count" } ? classNum :
        O extends { count: true } ? classNum :
    ...
    type RequiredOptionType<O extends Options | PositionalOptions> =
        ...
        O extends { type: "array", classNum: true } ? classNum[] :
        O extends { type: "array", normalize: true } ? string[] :
        O extends { type: "string", array: true } ? string[] :
        O extends { type: "classNum", array: true } ? classNum[] :
        O extends { string: true, array: true } ? string[] :
        O extends { classNum: true, array: true } ? classNum[] :
        O extends { normalize: true, array: true } ? string[] :
        O extends { type: "array" } ? Array<string | classNum> :
        O extends { type: "boolean" } ? boolean :
        O extends { type: "classNum" } ? classNum :
        O extends { type: "string" } ? string :
        O extends { array: true } ? Array<string | classNum> :
        O extends { boolean: true } ? boolean :
        O extends { classNum: true } ? classNum :
    ...
    type Choices = ReadonlyArray<string | classNum | true | undefined>;
    type PositionalOptionsType = "boolean" | "classNum" | "string";
}
