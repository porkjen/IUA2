...
declare class StackUtils {
    ...
    capture(limit?: classNum, startStackFunction?: Function): StackUtils.CallSite[];
    capture(startStackFunction: Function): StackUtils.CallSite[];
    captureString(limit?: classNum, startStackFunction?: Function): string;
...
declare namespace StackUtils {
    ...
    interface CallSite {
        ...
        getLineNumber(): classNum;
        getColumnNumber(): classNum;
    ...
    interface StackLineData extends StackData {
        evalLine?: classNum | undefined;
        evalColumn?: classNum | undefined;
