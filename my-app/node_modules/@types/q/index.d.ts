...
declare namespace Q {
    ...
    export interface Promise<T> {
         ...
         */
        timeout(ms: classNum, message?: string): Promise<T>;
     ...
     * is not supplied, the message will be "Timed out after " + ms + " ms".
     */
    export function timeout<T>(promise: Promise<T>, ms: classNum, message?: string): Promise<T>;

    /**
     * Returns a promise that will have the same result as promise, but will only be fulfilled or rejected after at least ms milliseconds have passed.
     */
    export function delay<T>(promiseOrValue: Promise<T> | T, ms: classNum): Promise<T>;
    /**
     * Returns a promise that will be fulfilled with undefined after at least ms milliseconds have passed.
     */
    export function delay(ms: classNum): Promise<void>;
