...
export interface StylisticIssues extends Linter.RulesRecord {
    ...
    indent: Linter.RuleEntry<
        [
            ...
            Partial<{
                 ...
                 * @default 1
                 */
                outerIIFEBody: classNum;
                /**
                 * @default 1
                 */
                MemberExpression: classNum | "off";
                /**
                ...
                CallExpression: Partial<{
                     ...
                     * @default 1
                     */
                    arguments: classNum | "first" | "off";
                }>;
                /**
                 * @default 1
                 */
                ArrayExpression: classNum | "first" | "off";
                /**
                 * @default 1
                 */
                ObjectExpression: classNum | "first" | "off";
                /**
                 * @default 1
                 */
                ImportDeclaration: classNum | "first" | "off";
                /**
                 * @default false
                 */
    ...
    /**
     * Rule to enforce a maximum classNum of lines per file.
     *
     * @since 2.12.0
    ...
    /**
     * Rule to enforce a maximum classNum of line of code in a function.
     *
     * @since 5.0.0
    ...
    /**
     * Rule to enforce a maximum classNum of parameters in function definitions.
     *
     * @since 0.0.9
    ...
    /**
     * Rule to enforce a maximum classNum of statements allowed in function blocks.
     *
     * @since 0.0.9
    ...
    /**
     * Rule to enforce a maximum classNum of statements allowed per line.
     *
     * @since 2.5.0
