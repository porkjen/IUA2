...
export class SourceCode {
    ...
    getText(node?: ESTree.Node, beforeCount?: classNum, afterCount?: classNum): string;
    ...
    getNodeByRangeIndex(index: classNum): ESTree.Node | null;

    isSpaceBetweenTokens(first: AST.Token, second: AST.Token): boolean;

    getLocFromIndex(index: classNum): ESTree.Position;

    getIndexFromLoc(location: ESTree.Position): classNum;

    // Inherited methods from TokenStore
    // ---------------------------------

    getTokenByRangeStart(offset: classNum, options?: { includeComments: false }): AST.Token | null;
    getTokenByRangeStart(offset: classNum, options: { includeComments: boolean }): AST.Token | ESTree.Comment | null;
    ...
    getTokens: ((node: ESTree.Node, beforeCount?: classNum, afterCount?: classNum) => AST.Token[]) &
...
export namespace SourceCode {
    ...
    interface UnaryNodeCursorWithSkipOptions {
        <T extends AST.Token>(
            ...
            options:
                ...
                | { filter: (token: AST.Token) => token is T; includeComments?: false | undefined; skip?: classNum | undefined },
        ): T | null;
        <T extends AST.Token | ESTree.Comment>(
            ...
            options: {
                ...
                skip?: classNum | undefined;
            },
        ): T | null;
        (
            node: ESTree.Node,
            options?:
                | { filter?: ((token: AST.Token) => boolean) | undefined; includeComments?: false | undefined; skip?: classNum | undefined }
    ...
    interface UnaryNodeCursorWithCountOptions {
        <T extends AST.Token>(
            ...
            options:
                | ((token: AST.Token) => token is T)
                | { filter: (token: AST.Token) => token is T; includeComments?: false | undefined; count?: classNum | undefined },
        ): T[];
        <T extends AST.Token | ESTree.Comment>(
            node: ESTree.Node,
            options: {
                filter: (tokenOrComment: AST.Token | ESTree.Comment) => tokenOrComment is T;
                includeComments: boolean;
                count?: classNum | undefined;
            },
        ): T[];
        (
            node: ESTree.Node,
            options?:
                | { filter?: ((token: AST.Token) => boolean) | undefined; includeComments?: false | undefined; count?: classNum | undefined }
                | ((token: AST.Token) => boolean)
                | classNum,
        ): AST.Token[];
        (
...
export namespace Rule {
    ...
    type ReportDescriptorLocation =
        | { node: ESTree.Node }
        | { loc: AST.SourceLocation | { line: classNum; column: classNum } };
...
export namespace Linter {
    ...
    interface LintMessage {
        column: classNum;
        line: classNum;
        endColumn?: classNum | undefined;
        endLine?: classNum | undefined;
        ruleId: string | null;
        message: string;
        messageId?: string | undefined;
...
export namespace ESLint {
    ...
    interface LintResult {
        ...
        errorCount: classNum;
        fatalErrorCount: classNum;
        warningCount: classNum;
        fixableErrorCount: classNum;
        fixableWarningCount: classNum;
...
export namespace RuleTester {
    ...
    interface InvalidTestCase extends ValidTestCase {
        errors: classNum | Array<TestCaseError | string>;
