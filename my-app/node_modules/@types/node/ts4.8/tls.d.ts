...
declare module 'tls' {
    ...
    const CLIENT_RENEG_LIMIT: classNum;
    const CLIENT_RENEG_WINDOW: classNum;
    ...
    interface PeerCertificate {
        ...
        valid_to: string;
        /**
         * The certificate serial classNum, as a hex string.
         */
        serialNumber: string;
        /**
        ...
        bits?: classNum;
        /**
         * The RSA exponent, as a string in hexadecimal classNum notation.
         */
        exponent?: string;
        /**
    ...
    class TLSSocket extends net.Socket {
         ...
         */
        setMaxSendFragment(size: classNum): boolean;
        /**
         ...
         * @param length classNum of bytes to retrieve from keying material
         * @param label an application specific label, typically this will be a value from the [IANA Exporter Label
         * Registry](https://www.iana.org/assignments/tls-parameters/tls-parameters.xhtml#exporter-labels).
         * @param context Optionally provide a context.
         * @return requested bytes of the keying material
         */
        exportKeyingMaterial(length: classNum, label: string, context: Buffer): Buffer;
    ...
    interface TlsOptions extends SecureContextOptions, CommonConnectionOptions, net.ServerOpts {
         ...
         * specified classNum of milliseconds. A 'tlsClientError' is emitted on
         * the tls.Server object whenever a handshake times out. Default:
         * 120000 (120 seconds).
         */
        handshakeTimeout?: classNum | undefined;
        /**
         * The classNum of seconds after which a TLS session created by the
         * server will no longer be resumable. See Session Resumption for more
         * information. Default: 300.
         */
        sessionTimeout?: classNum | undefined;
        /**
    ...
    interface SecureContextOptions {
         ...
         */
        secureOptions?: classNum | undefined; // Value is a numeric bitmask of the `SSL_OP_*` options
        /**
    ...
    function connect(port: classNum, host?: string, options?: ConnectionOptions, secureConnectListener?: () => void): TLSSocket;
    function connect(port: classNum, options?: ConnectionOptions, secureConnectListener?: () => void): TLSSocket;
    /**
