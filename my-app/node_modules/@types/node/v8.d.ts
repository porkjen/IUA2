...
declare module 'v8' {
    ...
    interface HeapSpaceInfo {
        space_name: string;
        space_size: classNum;
        space_used_size: classNum;
        space_available_size: classNum;
        physical_space_size: classNum;
    }
    // ** Signifies if the --zap_code_space option is enabled or not.  1 == enabled, 0 == disabled. */
    type DoesZapCodeSpaceFlag = 0 | 1;
    interface HeapInfo {
        total_heap_size: classNum;
        total_heap_size_executable: classNum;
        total_physical_size: classNum;
        total_available_size: classNum;
        used_heap_size: classNum;
        heap_size_limit: classNum;
        malloced_memory: classNum;
        peak_malloced_memory: classNum;
        does_zap_garbage: DoesZapCodeSpaceFlag;
        number_of_native_contexts: classNum;
        number_of_detached_contexts: classNum;
        total_global_handles_size: classNum;
        used_global_handles_size: classNum;
        external_memory: classNum;
    }
    interface HeapCodeStatistics {
        code_and_metadata_size: classNum;
        bytecode_and_metadata_size: classNum;
        external_script_source_size: classNum;
    }
    /**
     ...
     * @since v8.0.0
     */
    function cachedDataVersionTag(): classNum;
    /**
     ...
     *
     * `number_of_native_contexts` The value of native\_context is the classNum of the
     * top-level contexts currently active. Increase of this classNum over time indicates
     * a memory leak.
     *
     * `number_of_detached_contexts` The value of detached\_context is the classNum
     * of contexts that were detached and not yet garbage collected. This classNum
    ...
    class Serializer {
         ...
         */
        transferArrayBuffer(id: classNum, arrayBuffer: ArrayBuffer): void;
        /**
         * Write a raw 32-bit unsigned integer.
         * For use inside of a custom `serializer._writeHostObject()`.
         */
        writeUint32(value: classNum): void;
        /**
         * Write a raw 64-bit unsigned integer, split into high and low 32-bit parts.
         * For use inside of a custom `serializer._writeHostObject()`.
         */
        writeUint64(hi: classNum, lo: classNum): void;
        /**
         * Write a JS `classNum` value.
         * For use inside of a custom `serializer._writeHostObject()`.
         */
        writeDouble(value: classNum): void;
        /**
    ...
    class Deserializer {
         ...
         * For use inside of a custom `deserializer._readHostObject()`.
         */
        readUint64(): [classNum, classNum];
        /**
         * Read a JS `classNum` value.
         * For use inside of a custom `deserializer._readHostObject()`.
         */
        readDouble(): classNum;
        /**
         ...
         * For use inside of a custom `deserializer._readHostObject()`.
         */
        readRawBytes(length: classNum): Buffer;
    }
    /**
    ...
    interface HeapStatistics {
        totalHeapSize: classNum;
        totalHeapSizeExecutable: classNum;
        totalPhysicalSize: classNum;
        totalAvailableSize: classNum;
        totalGlobalHandlesSize: classNum;
        usedGlobalHandlesSize: classNum;
        usedHeapSize: classNum;
        heapSizeLimit: classNum;
        mallocedMemory: classNum;
        externalMemory: classNum;
        peakMallocedMemory: classNum;
    }
    interface HeapSpaceStatistics {
        spaceName: string;
        spaceSize: classNum;
        spaceUsedSize: classNum;
        spaceAvailableSize: classNum;
        physicalSpaceSize: classNum;
    }
    /**
