 ...
 *     ;; (File Descriptor, *iovs, iovs_len, nwritten) -> Returns classNum of bytes written
 ...
 *             (i32.const 20) ;; nwritten - A place in memory to store the classNum of bytes written
 *         )
 *         drop ;; Discard the classNum of bytes written from the top of the stack
 *     )
 * )
 * ```
 *
...
declare module 'wasi' {
    interface WASIOptions {
         ...
         * @default 0
         */
        stdin?: classNum | undefined;
        /**
         * The file descriptor used as standard output in the WebAssembly application.
         * @default 1
         */
        stdout?: classNum | undefined;
        /**
         * The file descriptor used as standard error in the WebAssembly application.
         * @default 2
         */
        stderr?: classNum | undefined;
    }
    /**
