...
declare module 'readline' {
    ...
    export interface ReadLineOptions {
        ...
        historySize?: classNum | undefined;
        prompt?: string | undefined;
        crlfDelay?: classNum | undefined;
        /**
        ...
        escapeCodeTimeout?: classNum | undefined;
        tabSize?: classNum | undefined;
    }
    /**
     ...
     * @return `false` if `stream` wishes for the calling code to wait for the `'drain'` event to be emitted before continuing to write additional data; otherwise `true`.
     */
    export function cursorTo(stream: NodeJS.WritableStream, x: classNum, y?: classNum, callback?: () => void): boolean;
    /**
     ...
     * @return `false` if `stream` wishes for the calling code to wait for the `'drain'` event to be emitted before continuing to write additional data; otherwise `true`.
     */
    export function moveCursor(stream: NodeJS.WritableStream, dx: classNum, dy: classNum, callback?: () => void): boolean;
}
