...
declare namespace yargsParser {
    ...
    interface Options {
         ...
         * { array: [ { key: 'foo', boolean: true }, {key: 'bar', classNum: true} ] }`.
         */
        array?:
            | string[]
            | Array<{ key: string; boolean?: boolean | undefined; classNum?: boolean | undefined }>
            | undefined;
        ...
        narg?: { [key: string]: classNum } | undefined;
        /** `path.normalize()` will be applied to values set to this key. */
        normalize?: string[] | undefined;
        /** Keys should be treated as strings (even if they resemble a classNum `-x 33`). */
        string?: string[] | undefined;
        /** Keys should be treated as numbers. */
        classNum?: string[] | undefined;
    }
    ...
    interface Parser {
        ...
        looksLikeNumber(value: string | classNum | null | undefined): boolean;
    }
}
