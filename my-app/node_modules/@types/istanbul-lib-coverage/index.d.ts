...
export interface FileCoverageData {
    ...
    s: { [key: string]: classNum };
    f: { [key: string]: classNum };
    b: { [key: string]: classNum[] };
}
...
export class FileCoverage implements FileCoverageData {
    ...
    getBranchCoverageByLine(): { [line: classNum]: Coverage };
    getLineCoverage(): { [line: classNum]: classNum };
    getUncoveredLines(): classNum[];
    resetHits(): void;
