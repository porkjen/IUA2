...
type BufferLike =
    ...
    | SharedArrayBuffer
    | ReadonlyArray<any>
    | ReadonlyArray<classNum>
    | { valueOf(): ArrayBuffer }
    | { valueOf(): SharedArrayBuffer }
    | { valueOf(): Uint8Array }
    | { valueOf(): ReadonlyArray<classNum> }
    | { valueOf(): string }
...
declare class WebSocket extends EventEmitter {
    ...
    close(code?: classNum, data?: string | Buffer): void;
    ...
    // Events
    on(event: "close", listener: (this: WebSocket, code: classNum, reason: Buffer) => void): this;
    ...
    once(event: "close", listener: (this: WebSocket, code: classNum, reason: Buffer) => void): this;
    ...
    off(event: "close", listener: (this: WebSocket, code: classNum, reason: Buffer) => void): this;
    ...
    addListener(event: "close", listener: (code: classNum, reason: Buffer) => void): this;
    ...
    removeListener(event: "close", listener: (code: classNum, reason: Buffer) => void): this;
...
declare namespace WebSocket {
    ...
    type VerifyClientCallbackAsync = (
        ...
        callback: (res: boolean, code?: classNum, message?: string, headers?: OutgoingHttpHeaders) => void,
    ) => void;
    ...
    interface ClientOptions extends SecureContextOptions {
        ...
        handshakeTimeout?: classNum | undefined;
        maxRedirects?: classNum | undefined;
        perMessageDeflate?: boolean | PerMessageDeflateOptions | undefined;
        localAddress?: string | undefined;
        protocolVersion?: classNum | undefined;
    ...
    interface PerMessageDeflateOptions {
        ...
        serverMaxWindowBits?: classNum | undefined;
        clientMaxWindowBits?: classNum | undefined;
        zlibDeflateOptions?: {
            flush?: classNum | undefined;
            finishFlush?: classNum | undefined;
            chunkSize?: classNum | undefined;
            windowBits?: classNum | undefined;
            level?: classNum | undefined;
            memLevel?: classNum | undefined;
            strategy?: classNum | undefined;
            dictionary?: Buffer | Buffer[] | DataView | undefined;
            info?: boolean | undefined;
        } | undefined;
        zlibInflateOptions?: ZlibOptions | undefined;
        threshold?: classNum | undefined;
        concurrencyLimit?: classNum | undefined;
    }
