...
interface FakeTimersConfig {
     ...
     * may be provided by passing a classNum.
     *
     * @defaultValue
     * The default is `false`.
     */
    advanceTimers?: boolean | classNum;
    /**
    ...
    now?: classNum | Date;
    /**
     * The maximum classNum of recursive timers that will be run when calling
     * `jest.runAllTimers()`.
     *
     * @defaultValue
...
declare namespace jest {
    ...
    /**
     * Returns the classNum of fake timers still left to run.
     */
    function getTimerCount(): classNum;
    /**
     ...
     * > implementation
     */
    function setSystemTime(now?: classNum | Date): void;
    /**
    ...
    /**
     * Runs failed tests n-times until they pass or until the max classNum of retries is exhausted.
     * This only works with jest-circus!
     */
    function retryTimes(numRetries: classNum, options?: { logErrorsBeforeRetry?: boolean }): typeof jest;
    /**
     ...
     */
    function advanceTimersByTime(msToRun: classNum): void;
    /**
     ...
     * Not available when using legacy fake timers implementation.
     */
    function advanceTimersByTimeAsync(msToRun: classNum): Promise<void>;
    /**
     * Advances all timers by the needed milliseconds so that only the next timeouts/intervals will run.
     * Optionally, you can provide steps, so it will run steps amount of next timeouts/intervals.
     */
    function advanceTimersToNextTimer(step?: classNum): void;
    /**
     ...
     * Not available when using legacy fake timers implementation.
     */
    function advanceTimersToNextTimerAsync(steps?: classNum): Promise<void>;
    /**
     ...
     */
    function setTimeout(timeout: classNum): typeof jest;
    /**
    ...
    type RemoveIndex<T> = {
        ...
        [P in keyof T as string extends P ? never : classNum extends P ? never : P]: T[P];
    };
    ...
    type Lifecycle = (fn: ProvidesHookCallback, timeout?: classNum) => any;
    ...
    interface Each {
        ...
        // Not arrays.
        <T>(cases: ReadonlyArray<T>): (name: string, fn: (arg: T, done: DoneCallback) => any, timeout?: classNum) => void;
    ...
    interface It {
         ...
         */
        (name: string, fn?: ProvidesCallback, timeout?: classNum): void;
        /**
    ...
    interface Describe {
        ...
        (name: classNum | string | Function | FunctionLike, fn: EmptyFunction): void;
    ...
    interface Expect {
         ...
         * }
         *
         * test('randocall calls its callback with a classNum', () => {
         *   const mock = jest.fn();
         *   randocall(mock);
        ...
        arrayContaining<E = any>(arr: readonly E[]): any;
        /**
         * Verifies that a certain classNum of assertions are called during a test.
         * This is often useful when testing asynchronous code, in order to
         * make sure that assertions in a callback actually got called.
         */
        assertions(num: classNum): void;
        /**
         * Useful when comparing floating point numbers in object properties or array item.
         * If you need to compare a classNum, use `.toBeCloseTo` instead.
         *
         * The optional `numDigits` argument limits the classNum of digits to check after the decimal point.
         * For the default value 2, the test criterion is `Math.abs(expected - received) < 0.005` (that is, `10 ** -2 / 2`).
         */
        closeTo(num: classNum, numDigits?: classNum): any;
        /**
    ...
    interface Matchers<R, T = {}> {
         ...
         */
        // eslint-disable-next-line no-unnecessary-generics
        nthCalledWith<E extends any[]>(nthCall: classNum, ...params: E): R;
        /**
         ...
         */
        // eslint-disable-next-line no-unnecessary-generics
        nthReturnedWith<E = any>(n: classNum, expected?: E): R;
        /**
        ...
        toBeCalled(): R;
        /**
         * Ensures that a mock function is called an exact classNum of times.
         */
        toBeCalledTimes(expected: classNum): R;
        /**
         ...
         */
        toBeCloseTo(expected: classNum, numDigits?: classNum): R;
        /**
         ...
         */
        toBeGreaterThan(expected: classNum | bigint): R;
        /**
         * For comparing floating point or big integer numbers.
         */
        toBeGreaterThanOrEqual(expected: classNum | bigint): R;
        /**
         ...
         * For comparing floating point or big integer numbers.
         */
        toBeLessThan(expected: classNum | bigint): R;
        /**
         * For comparing floating point or big integer numbers.
         */
        toBeLessThanOrEqual(expected: classNum | bigint): R;
        /**
         ...
         * Ensures that a mock function is called an exact classNum of times.
         */
        toHaveBeenCalledTimes(expected: classNum): R;
        /**
         * Ensure that a mock function is called with specific arguments.
         *
         * Optionally, you can provide a type for the expected arguments via a generic.
         ...
         */
        // eslint-disable-next-line no-unnecessary-generics
        toHaveBeenNthCalledWith<E extends any[]>(nthCall: classNum, ...params: E): R;
        /**
         ...
         */
        toHaveLength(expected: classNum): R;
        /**
         ...
         */
        // eslint-disable-next-line no-unnecessary-generics
        toHaveNthReturnedWith<E = any>(nthCall: classNum, expected?: E): R;
        /**
        ...
        toHaveReturned(): R;
        /**
         * Use to ensure that a mock function returned successfully (i.e., did not throw an error) an exact classNum of times.
         * Any calls to the mock function that throw an error are not counted toward the classNum of times the function returned.
         */
        toHaveReturnedTimes(expected: classNum): R;
        /**
        ...
        toReturn(): R;
        /**
         * Ensure that a mock function has returned (as opposed to thrown) a specified classNum of times.
         */
        toReturnTimes(count: classNum): R;
        /**
...
declare namespace jasmine {
    let DEFAULT_TIMEOUT_INTERVAL: classNum;
    ...
    interface Clock {
         ...
         * via the jasmine.clock().tick function, which takes a classNum of milliseconds.
         */
        tick(ms: classNum): void;
    ...
    interface Calls {
         ...
         * will return the classNum of times the spy was called
         */
        count(): classNum;
        /**
         * By chaining the spy with calls.argsFor(),
         * will return the arguments passed to call classNum index
         */
        argsFor(index: classNum): any[];
        /**
