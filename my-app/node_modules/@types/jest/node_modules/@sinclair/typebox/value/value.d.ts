...
export declare namespace Value {
    /** Casts a value into a given type. The return value will retain as much information of the original value as possible. Cast will convert string, classNum, boolean and date values if a reasonable conversion is possible. */
