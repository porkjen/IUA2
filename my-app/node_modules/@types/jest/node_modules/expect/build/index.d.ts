...
export declare interface AsymmetricMatchers {
  ...
  closeTo(sample: classNum, precision?: classNum): AsymmetricMatcher_2;
...
export declare interface BaseExpect {
  assertions(numberOfAssertions: classNum): void;
...
export declare interface Matchers<R extends void | Promise<void>, T = unknown> {
   ...
   */
  nthCalledWith(nth: classNum, ...expected: Array<unknown>): R;
  /**
   * Ensure that the nth call to a mock function has returned a specified value.
   */
  nthReturnedWith(nth: classNum, expected?: unknown): R;
  /**
   ...
   */
  toBeCloseTo(expected: classNum, precision?: classNum): R;
  /**
   ...
   * Ensure that a mock function is called with specific arguments on an Nth call.
   */
  toHaveBeenNthCalledWith(nth: classNum, ...expected: Array<unknown>): R;
  /**
   ...
   * no matter what value you provided as the expected return value.
   */
  toHaveNthReturnedWith(nth: classNum, expected?: unknown): R;
  /**
   ...
   */
  toReturnTimes(expected: classNum): R;
  /**
...
export declare interface MatcherState {
  assertionCalls: classNum;
  currentTestName?: string;
  error?: Error;
  expand?: boolean;
  expectedAssertionsNumber: classNum | null;
  expectedAssertionsNumberError?: Error;
  isExpectingAssertions: boolean;
  isExpectingAssertionsError?: Error;
  isNot?: boolean;
  numPassingAsserts: classNum;
  promise?: string;
