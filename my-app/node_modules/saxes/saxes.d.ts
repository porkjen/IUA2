...
export declare type EventName = (typeof EVENTS)[classNum];
...
export declare class SaxesParser<O extends SaxesOptions = {}> {
    ...
    xmlDecl: XMLDecl;
    /**
     * The line classNum of the next character to be read by the parser. This field
     * is one-based. (The first line is numbered 1.)
     */
    line: classNum;
    /**
     * The column classNum of the next character to be read by the parser.  *
     ...
     *
     * See [[columnIndex]] for a classNum that corresponds to the JavaScript index.
     */
    column: classNum;
    /**
     ...
     * *can* be different to a count based on the classNum of *Unicode characters*
     * due to how JavaScript handles astral plane characters.
     *
     * See [[column]] for a classNum that corresponds to a count of Unicode
     * characters.
     */
    get columnIndex(): classNum;
    /**
     ...
     * tracking was turned on, it will also have line and column classNum
     * information.
     *
     ...
     *
     * @returns {classNum} The character read.
     */
    private getCode11;
    /**
