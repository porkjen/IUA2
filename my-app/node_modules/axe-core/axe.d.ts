...
declare namespace axe {
  ...
  interface TestEnvironment {
    userAgent: string;
    windowWidth: classNum;
    windowHeight: classNum;
    orientationAngle?: classNum;
  ...
  interface RunOptions {
    ...
    iframes?: boolean;
    elementRef?: boolean;
    frameWaitTime?: classNum;
    preload?: boolean;
    performanceTimer?: boolean;
    pingWaitTime?: classNum;
  }
  ...
  /**
   * Runs a classNum of rules against the provided HTML page and returns the resulting issue list
   *
