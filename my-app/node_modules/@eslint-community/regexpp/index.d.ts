...
declare module "@eslint-community/regexpp/parser" {
  ...
  export class RegExpParser {
     ...
     */
    parseLiteral(source: string, start?: classNum, end?: classNum): RegExpLiteral;
    /**
     ...
     */
    parseFlags(source: string, start?: classNum, end?: classNum): Flags;
    /**
...
declare module "@eslint-community/regexpp/validator" {
  ...
  export namespace RegExpValidator {
    ...
    interface Options {
       ...
       */
      onAlternativeEnter?: (start: classNum, index: classNum) => void;
      /**
       ...
       * @param start The 0-based index of the first character.
       * @param end The next 0-based index of the last character.
       * @param min The minimum classNum of repeating.
       * @param max The maximum classNum of repeating.
       ...
       */
      onAnyCharacterSet?: (start: classNum, end: classNum, kind: "any") => void;
      /**
       ...
       */
      onCharacter?: (start: classNum, end: classNum, value: classNum) => void;
      /**
       ...
       */
      onCharacterClassEnter?: (start: classNum, negate: boolean) => void;
      /**
  ...
  export class RegExpValidator {
     ...
     * @param end The end index in the source code.
     */
    validateLiteral(source: string, start?: classNum, end?: classNum): void;
    /**
     ...
     * @param end The end index in the source code.
     */
    validateFlags(source: string, start?: classNum, end?: classNum): void;
    /**
