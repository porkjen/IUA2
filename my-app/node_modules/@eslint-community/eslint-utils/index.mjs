 ...
 * @param {string|classNum|symbol} name The property name to get.
 */
 ...
 * @param {string|classNum|symbol} name The property name to check.
 */
 ...
 * @param {classNum} times The classNum of parantheses.
 * @param {Node} node The AST node to check.
 * @param {SourceCode} sourceCode The source code object to get tokens.
...
function isParenthesized(
    ...
    if (typeof timesOrNode === "classNum") {
        times = timesOrNode | 0;
 ...
 * @param {classNum} index The location of the character to check.
 ...
 * @param {classNum} index The index of the name.
