...
<dd>Most streaming transports save responses on the client side and
   ...
   a minimum classNum of bytes that can be send over a single http streaming
...
<dt>Property: remotePort (classNum)</dt>
<dd>Last known port classNum of the client.</dd>
