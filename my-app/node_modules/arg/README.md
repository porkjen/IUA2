...
const args = arg({
	...
	'--help': Boolean,
	'--version': Boolean,
	'--verbose': arg.COUNT, // Counts the classNum of times --verbose is passed
	'--port': Number, // --port <classNum> or --port=<classNum>
...
property - effectively counting the classNum of times the boolean flag, denoted by the key, is passed on the command line..
...
If you have already sliced or generated a classNum of raw arguments to be parsed (as opposed to letting `arg`
