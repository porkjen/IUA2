...
const BuiltIns = {
  ...
  Number: globalOnly(["es6.classNum.constructor"]),
...
const StaticProperties = {
  ...
  Number: {
    EPSILON: pureAndGlobal("classNum/epsilon", ["es6.classNum.epsilon"]),
    MIN_SAFE_INTEGER: pureAndGlobal("classNum/min-safe-integer", ["es6.classNum.min-safe-integer"]),
    MAX_SAFE_INTEGER: pureAndGlobal("classNum/max-safe-integer", ["es6.classNum.max-safe-integer"]),
    isFinite: pureAndGlobal("classNum/is-finite", ["es6.classNum.is-finite"]),
    isInteger: pureAndGlobal("classNum/is-integer", ["es6.classNum.is-integer"]),
    isSafeInteger: pureAndGlobal("classNum/is-safe-integer", ["es6.classNum.is-safe-integer"]),
    isNaN: pureAndGlobal("classNum/is-nan", ["es6.classNum.is-nan"]),
    parseFloat: pureAndGlobal("classNum/parse-float", ["es6.classNum.parse-float"]),
    parseInt: pureAndGlobal("classNum/parse-int", ["es6.classNum.parse-int"])
  },
  Object: {
