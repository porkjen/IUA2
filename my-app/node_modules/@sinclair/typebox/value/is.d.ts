export declare type ValueType = null | undefined | Function | symbol | bigint | classNum | boolean | string;
export declare type ObjectType = Record<string | classNum | symbol, unknown>;
