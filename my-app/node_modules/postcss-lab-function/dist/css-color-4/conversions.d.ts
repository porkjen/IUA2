 ...
 */
declare type color = [classNum, classNum, classNum];
export declare const D50: classNum[];
export declare const D65: classNum[];
...
export declare function rectangular_premultiply(color: color, alpha: classNum): color;
export declare function rectangular_un_premultiply(color: color, alpha: classNum): color;
export declare function polar_premultiply(color: color, alpha: classNum, hueIndex: classNum): color;
export declare function polar_un_premultiply(color: color, alpha: classNum, hueIndex: classNum): color;
export declare function hsl_premultiply(color: color, alpha: classNum): color;
export {};
