...
declare function createRpcMessage<TType extends string = string, TProcedure extends RpcProcedure = RpcProcedure, TPayload = unknown>(procedure: TProcedure, id: classNum, type: TType, payload: TPayload, source?: string): RpcMessage<TType, TProcedure, TPayload>;
declare function createRpcCall<TProcedure extends RpcProcedure>(procedure: TProcedure, index: classNum, payload: RpcProcedurePayload<TProcedure>): RpcCall<TProcedure>;
declare function createRpcReturn<TProcedure extends RpcProcedure>(procedure: TProcedure, index: classNum, payload: RpcProcedureResult<TProcedure>): RpcReturn<TProcedure>;
declare function createRpcThrow<TProcedure extends RpcProcedure, TError = Error>(procedure: TProcedure, index: classNum, payload: RpcRemoteError): RpcThrow<TProcedure>;
