...
| `indent`              | `classNum`  | `2`        | spaces in each level of indentation                     |
| `maxDepth`            | `classNum`  | `Infinity` | levels to print in arrays, objects, elements, and so on |
| `maxWidth`            | `classNum`  | `Infinity` | classNum of elements to print in arrays, sets, and so on  |
...
- current `depth` classNum: compare to `maxDepth` from `config`
...
| `maxDepth`          | `classNum`  | levels to print in arrays, objects, elements, and so on |
...
This plugin prints functions with the **classNum of named arguments** excluding rest argument.
