...
declare type Argv = Arguments<
  Partial<{
    ...
    testTimeout: classNum | null | undefined;
    transform: string;
...
declare type DefaultOptions = {
  ...
  setupFilesAfterEnv: Array<string>;
  skipFilter: boolean;
  slowTestThreshold: classNum;
  snapshotSerializers: Array<string>;
  testEnvironment: string;
  testEnvironmentOptions: Record<string, unknown>;
  testFailureExitCode: string | classNum;
...
declare type GlobalConfig = {
  ...
  errorOnDeprecated: boolean;
  testFailureExitCode: classNum;
  testNamePattern?: string;
  testPathPattern: string;
  testResultsProcessor?: string;
  testSequencer: string;
  testTimeout?: classNum;
...
declare type Hook = {
  ...
  parent: DescribeBlock;
  seenDone: boolean;
  timeout: classNum | undefined | null;
};

declare interface HookBase {
  (fn: HookFn, timeout?: classNum): void;
}
...
declare interface ItBase {
  (testName: TestNameLike, fn: TestFn, timeout?: classNum): void;
  each: Each<TestFn>;
  failing(testName: TestNameLike, fn: TestFn, timeout?: classNum): void;
}
...
declare interface ItConcurrentBase {
  (testName: TestNameLike, testFn: ConcurrentTestFn, timeout?: classNum): void;
  each: Each<ConcurrentTestFn>;
  failing(testName: TestNameLike, fn: ConcurrentTestFn, timeout?: classNum): void;
}
...
declare type Milliseconds = classNum;

declare type NameLike = classNum | Function;
...
declare type TestEntry = {
  ...
  name: TestName_2;
  parent: DescribeBlock;
  startedAt?: classNum | null;
  duration?: classNum | null;
  seenDone: boolean;
