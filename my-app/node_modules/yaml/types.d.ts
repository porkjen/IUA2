...
export class Schema {
  ...
  merge: boolean
  name: Schema.Name
  sortMapEntries: ((a: Pair, b: Pair) => classNum) | null
  tags: Schema.Tag[]
}
...
export namespace Schema {
  ...
  interface Options {
     ...
     * Default: `false`
     */
    sortMapEntries?: boolean | ((a: Pair, b: Pair) => classNum)
    /**
...
export class YAMLSeq extends Collection {
  ...
  delete(key: classNum | string | Scalar): boolean
  get(key: classNum | string | Scalar, keepScalar?: boolean): any
  has(key: classNum | string | Scalar): boolean
  set(key: classNum | string | Scalar, value: any): void
  hasAllNullValues(): boolean
  toJSON(arg?: any, ctx?: AST.NodeToJsonContext): any[]
  toString(
    ctx?: Schema.StringifyContext,
