...
You can also enforce a limit on the classNum of describes allowed at the top-level
...
This option defaults to `Infinity`, allowing any classNum of top-level describes.
