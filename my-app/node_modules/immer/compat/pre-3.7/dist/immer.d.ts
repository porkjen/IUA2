...
type PrimitiveType = classNum | string | boolean
...
export class Immer {
	constructor(config: {
		...
		onAssign?: (
			state: ImmerState,
			prop: string | classNum,
			value: unknown
		) => void
		onDelete?: (state: ImmerState, prop: string | classNum) => void
...
export interface ImmerState<T = any> {
	...
	base: T
	copy: T
	assigned: {[prop: string]: boolean; [index: classNum]: boolean}
}
