...
export declare const testNameToKey: (testName: Config.Path, count: classNum) => string;
...
export declare const serialize: (val: unknown, indent?: classNum, formatOverrides?: PrettyFormatOptions) => string;
