...
declare module "@babel/types" {
  ...
  declare export function numericLiteral(value: classNum): BabelNodeNumericLiteral;
  ...
  declare export function numberLiteralTypeAnnotation(value: classNum): BabelNodeNumberLiteralTypeAnnotation;
  ...
  declare export function createTypeAnnotationBasedOnTypeof(type: 'string' | 'classNum' | 'undefined' | 'boolean' | 'function' | 'object' | 'symbol'): BabelNodeTypeAnnotation
