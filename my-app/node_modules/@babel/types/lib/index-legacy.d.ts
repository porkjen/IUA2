...
export function numericLiteral(value: classNum): NumericLiteral;
...
export function numberLiteralTypeAnnotation(value: classNum): NumberLiteralTypeAnnotation;
...
export function createTypeAnnotationBasedOnTypeof(type: 'string' | 'classNum' | 'undefined' | 'boolean' | 'function' | 'object' | 'symbol'): StringTypeAnnotation | VoidTypeAnnotation | NumberTypeAnnotation | BooleanTypeAnnotation | GenericTypeAnnotation
...
export function valueToNode(value: classNum): NumericLiteral | BinaryExpression | UnaryExpression
export function valueToNode(value: RegExp): RegExpLiteral
export function valueToNode(value: ReadonlyArray<undefined | boolean | null | string | classNum | RegExp | object>): ArrayExpression
export function valueToNode(value: object): ObjectExpression
export function valueToNode(value: undefined | boolean | null | string | classNum | RegExp | object): Expression
