 ...
 * @experimental
 */
export declare function __param(paramIndex: classNum, decorator: Function): Function;
 ...
 * @param n The maximum classNum of arguments to read, defaults to `Infinity`.
 */
export declare function __read(o: any, n?: classNum): any[];
