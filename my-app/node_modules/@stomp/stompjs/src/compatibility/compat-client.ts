...
export class CompatClient extends Client {
   ...
   */
  public maxWebSocketFrameSize: classNum = 16 * 1024;
   ...
   * **Deprecated**
   *
   * The `connect` method accepts different classNum of arguments and types. See the Overloads list. Use the
   ...
   * **Deprecated**
   */
  set reconnect_delay(value: classNum) {
   ...
   * **Deprecated**
   */
  set heartbeat(value: { incoming: classNum; outgoing: classNum }) {
