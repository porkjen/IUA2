...
export class FrameImpl implements IFrame {
  ...
  private bodyLength(): classNum {
    const binaryBody = this.binaryBody;
    return binaryBody ? binaryBody.length : 0;
  }

  /**
   * Compute the size of a UTF-8 string by counting its classNum of bytes
   * (and not the classNum of characters composing the string)
   */
  private static sizeOfUTF8(s: string): classNum {
