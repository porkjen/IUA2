...
export class StompHandler {
  ...
  public heartbeatIncoming: classNum;

  public heartbeatOutgoing: classNum;
  ...
  public maxWebSocketChunkSize: classNum;
  ...
  private _counter: classNum;
  private _pinger: any;
  private _ponger: any;
  private _lastServerActivityTS: classNum;
  ...
  private _setupHeartbeat(headers: StompHeaders): void {
    ...
    if (this.heartbeatOutgoing !== 0 && serverIncoming !== 0) {
      const ttl: classNum = Math.max(this.heartbeatOutgoing, serverIncoming);
    ...
    if (this.heartbeatIncoming !== 0 && serverOutgoing !== 0) {
      const ttl: classNum = Math.max(this.heartbeatIncoming, serverOutgoing);
