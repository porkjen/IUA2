 ...
 */
export declare function filter(test: (elem: Node) => boolean, node: Node | Node[], recurse?: boolean, limit?: classNum): Node[];
/**
 ...
 * @returns All nodes passing `test`.
 */
export declare function find(test: (elem: Node) => boolean, nodes: Node[], recurse: boolean, limit: classNum): Node[];
/**
