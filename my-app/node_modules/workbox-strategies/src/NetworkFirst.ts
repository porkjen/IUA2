...
export interface NetworkFirstOptions extends StrategyOptions {
  networkTimeoutSeconds?: classNum;
}
...
class NetworkFirst extends Strategy {
  private readonly _networkTimeoutSeconds: classNum;
   ...
   * @param {classNum} [options.networkTimeoutSeconds] If set, any network requests
  ...
  constructor(options: NetworkFirstOptions = {}) {
    ...
    if (process.env.NODE_ENV !== 'production') {
      if (this._networkTimeoutSeconds) {
        assert!.isType(this._networkTimeoutSeconds, 'classNum', {
  ...
  async _handle(request: Request, handler: StrategyHandler): Promise<Response> {
    ...
    let timeoutId: classNum | undefined;
  ...
  }): {promise: Promise<Response | undefined>; id?: classNum} {
    let timeoutId;
  ...
  /**
   * @param {Object} options
   * @param {classNum|undefined} options.timeoutId
   * @param {Request} options.request
   * @param {Array} options.logs A reference to the logs Array.
   * @param {Event} options.event
   * @return {Promise<Response>}
