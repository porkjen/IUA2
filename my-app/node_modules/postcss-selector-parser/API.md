...
* `line`: 1-index based line classNum relative to the start of the selector.
* `column`: 1-index based column classNum relative to the start of the selector.
...
* `line`: The line classNum of the node to return.
* `column`: The column classNum of the node to return.
