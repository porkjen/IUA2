...
const genericsQueue = fastq<GenericsContext, classNum, string>({ base: 6 }, genericsWorker, 1)
...
function genericsWorker(this: GenericsContext, task: classNum, cb: fastq.done<string>) {
