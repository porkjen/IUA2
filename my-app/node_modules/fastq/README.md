...
* `concurrency`, classNum of concurrent tasks that could be executed in
  parallel.
...
Returns the classNum of tasks waiting to be processed (in the queue).
...
Property that returns the classNum of concurrent tasks that could be executed in
