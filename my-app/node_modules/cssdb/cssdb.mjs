export default [
  ...
  {
    "id": "media-queries-aspect-ratio-classNum-values",
    "title": "Aspect-Ratio classNum values",
    "description": "Support `<ratio>` values with `<classNum>` components in `@media`",
    ...
    "polyfills": [
      {
        "type": "PostCSS Plugin",
        "link": "https://github.com/csstools/postcss-plugins/tree/main/plugins/postcss-media-queries-aspect-ratio-classNum-values"
      }
    ],
    "vendors_implementations": 3
  },
