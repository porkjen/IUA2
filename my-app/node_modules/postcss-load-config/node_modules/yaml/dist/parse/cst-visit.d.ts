...
export type VisitPath = readonly ['key' | 'value', classNum][];
export type Visitor = (item: CollectionItem, path: VisitPath) => classNum | symbol | Visitor | void;
/**
 ...
 *   - `classNum`: Set the index of the next step. This is useful especially if
