...
export declare function stringify(value: any, replacer?: Replacer | null, options?: string | classNum | (DocumentOptions & SchemaOptions & ParseOptions & CreateNodeOptions & ToStringOptions)): string;
