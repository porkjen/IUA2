...
export declare class YAMLError extends Error {
    ...
    code: ErrorCode;
    message: string;
    pos: [classNum, classNum];
    linePos?: [LinePos] | [LinePos, LinePos];
    constructor(name: YAMLError['name'], pos: [classNum, classNum], code: ErrorCode, message: string);
}
export declare class YAMLParseError extends YAMLError {
    constructor(pos: [classNum, classNum], code: ErrorCode, message: string);
}
