...
export type visitorFn<T> = (key: classNum | 'key' | 'value' | null, node: T, path: readonly (Document | Node | Pair)[]) => void | symbol | classNum | Node | Pair;
...
export type asyncVisitorFn<T> = (key: classNum | 'key' | 'value' | null, node: T, path: readonly (Document | Node | Pair)[]) => void | symbol | classNum | Node | Pair | Promise<void | symbol | classNum | Node | Pair>;
 ...
 *   - `classNum`: While iterating the items of a sequence or map, set the index
