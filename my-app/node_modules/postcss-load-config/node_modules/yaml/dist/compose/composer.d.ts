...
type ErrorSource = classNum | [classNum, classNum] | Range | {
    offset: classNum;
    source?: string;
};
...
export declare class Composer<Contents extends ParsedNode = ParsedNode, Strict extends boolean = true> {
     ...
     */
    compose(tokens: Iterable<Token>, forceDoc?: boolean, endOffset?: classNum): Generator<Document.Parsed<Contents, Strict>, void, unknown>;
     ...
     * @param endOffset - Should be set if `forceDoc` is also set, to set the document range end and to indicate errors correctly.
     */
    end(forceDoc?: boolean, endOffset?: classNum): Generator<Document.Parsed<Contents, Strict>, void, unknown>;
}
export {};
