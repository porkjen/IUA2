...
/** Utility type mapper */
export type NodeType<T> = T extends string | classNum | bigint | boolean | null | undefined ? Scalar<T> : T extends Date ? Scalar<string | Date> : T extends Array<any> ? YAMLSeq<NodeType<T[classNum]>> : T extends {
    [key: string]: any;
...
export type Range = [classNum, classNum, classNum];
