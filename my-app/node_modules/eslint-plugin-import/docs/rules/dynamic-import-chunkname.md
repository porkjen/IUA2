...
You can also configure the regex format you'd like to accept for the webpackChunkName - for example, if we don't want the classNum 6 to show up in our chunk names:
 ```javascript
{
