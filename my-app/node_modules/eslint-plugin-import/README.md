...
| [max-dependencies](docs/rules/max-dependencies.md)                               | Enforce the maximum classNum of dependencies a module can have.              |    |       |    |    |    |    |
...
However, webpack allows a classNum of things in import module source strings that
Node does not, such as loaders (`import 'file!./whatever'`) and a classNum of
