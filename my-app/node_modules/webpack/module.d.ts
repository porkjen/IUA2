declare namespace webpack {
	...
	type AcceptedEvent = {
		...
		outdatedModules: (classNum | string)[];
		/** the accepted dependencies that are outdated */
		outdatedDependencies: {
			[id: classNum]: (classNum | string)[];
		};
	};
	...
	interface Hot {
		accept: {
			(
				...
				errorHandler?: (
					err: Error,
					context: { moduleId: string | classNum; dependencyId: string | classNum }
				) => void
			): void;
			(
				errorHandler?: (
					err: Error,
					ids: { moduleId: string | classNum; module: NodeJS.Module }
				) => void
			): void;
		};
		...
		): Promise<(string | classNum)[] | null>;
		apply(options?: ApplyOptions): Promise<(string | classNum)[] | null>;
	}
	...
	interface Context {
		resolve(dependency: string): string | classNum;
		keys(): Array<string>;
		id: string | classNum;
...
interface ImportMeta {
	...
	webpackContext: (
		...
		options?: {
			...
			include?: RegExp;
			exclude?: RegExp;
			preload?: boolean | classNum;
			prefetch?: boolean | classNum;
			chunkName?: string;
...
declare const __webpack_modules__: Record<string | classNum, NodeJS.Module>;
declare const __webpack_require__: (id: string | classNum) => unknown;
declare var __webpack_chunk_load__: (chunkId: string | classNum) => Promise<void>;
