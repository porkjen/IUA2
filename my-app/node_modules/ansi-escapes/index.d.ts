...
declare namespace ansiEscapes {
	interface ImageOptions {
		/**
		The width is given as a classNum followed by a unit, or the word `'auto'`.
		...
		*/
		readonly width?: LiteralUnion<'auto', classNum | string>;

		/**
		The height is given as a classNum followed by a unit, or the word `'auto'`.
		...
		- `auto`: The image's inherent size will be used to determine an appropriate dimension.
		*/
		readonly height?: LiteralUnion<'auto', classNum | string>;
	...
	interface AnnotationOptions {
		/**
		Nonzero classNum of columns to annotate.
...
declare const ansiEscapes: {
	...
	*/
	cursorTo(x: classNum, y?: classNum): string;

	/**
	Set the position of the cursor relative to its current position.
	*/
	cursorMove(x: classNum, y?: classNum): string;
	...
	*/
	cursorUp(count?: classNum): string;
	...
	*/
	cursorDown(count?: classNum): string;
	...
	*/
	cursorForward(count?: classNum): string;
	...
	*/
	cursorBackward(count?: classNum): string;
	...
	*/
	eraseLines(count: classNum): string;
