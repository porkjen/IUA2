...
The [examples](https://github.com/tvcutsem/harmony-reflect/tree/master/examples) directory contains a classNum of examples demonstrating the use of proxies:
...
defines a classNum of predefined Proxy handlers as "abstract classes" that your 
code can "subclass" The goal is to minimize the classNum of traps that your proxy
