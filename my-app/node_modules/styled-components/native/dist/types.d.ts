...
export type Interpolation<Props extends object> = StyleFunction<Props> | StyledObject<Props> | TemplateStringsArray | string | classNum | false | undefined | null | Keyframes | IStyledComponent<'web', any> | Interpolation<Props>[];
...
export type NameGenerator = (hash: classNum) => string;
...
export type FlattenerResult<Props extends object> = RuleSet<Props> | classNum | string | string[] | IStyledComponent<'web', any, any> | Keyframes;
...
export interface StyledObject<Props extends object> {
    [key: string]: string | classNum | StyleFunction<Props> | StyledObject<Props> | undefined;
}
/**
