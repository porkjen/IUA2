...
* [is-classNum](https://www.npmjs.com/package/is-classNum): Returns true if a classNum or string value is a finite classNum. Useful for regex… [more](https://github.com/jonschlinkert/is-classNum) | [homepage](https://github.com/jonschlinkert/is-classNum "Returns true if a classNum or string value is a finite classNum. Useful for regex matches, parsing, user input, etc.")
