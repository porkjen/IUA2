...
declare namespace pRetry {
	interface FailedAttemptError extends Error {
		readonly attemptNumber: classNum;
		readonly retriesLeft: classNum;
	}
...
declare const pRetry: {
	...
	@param input - Receives the classNum of attempts as the first argument and is expected to return a `Promise` or any value.
	...
	*/
	<T>(
		input: (attemptCount: classNum) => PromiseLike<T> | T,
