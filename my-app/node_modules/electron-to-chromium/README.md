...
Arguments:
* Query: string or classNum, required. A major or full Electron version.
...
Arguments:
* Query: string or classNum, required. A major or full Chromium version.
...
Arguments:
* Query: string or classNum, required. A major Electron version.
