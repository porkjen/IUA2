...
export declare class Token {
    ...
    contextId: classNum | null;
    rhsEndIndex: classNum | null;
    isExpression: boolean;
    numNullishCoalesceStarts: classNum;
    numNullishCoalesceEnds: classNum;
    isOptionalChainStart: boolean;
    isOptionalChainEnd: boolean;
    subscriptStartIndex: classNum | null;
    nullishStartIndex: classNum | null;
}
...
export declare function pushTypeContext(existingTokensInType: classNum): boolean;
...
export declare function nextTokenStart(): classNum;
export declare function nextTokenStartSince(pos: classNum): classNum;
export declare function lookaheadCharCode(): classNum;
export declare function nextToken(): void;
export declare function skipLineComment(startSkip: classNum): void;
...
export declare function getTokenFromCode(code: classNum): void;
