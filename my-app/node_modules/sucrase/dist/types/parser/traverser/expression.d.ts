...
export declare function baseParseSubscripts(startTokenIndex: classNum, noCalls?: boolean): void;
/** Set 'state.stop = true' to indicate that we should stop parsing subscripts. */
export declare function baseParseSubscript(startTokenIndex: classNum, noCalls: boolean, stopState: StopState): void;
...
export declare function parsePropertyName(objectContextId: classNum): void;
export declare function parseMethod(functionStart: classNum, isConstructor: boolean): void;
export declare function parseArrowExpression(startTokenIndex: classNum): void;
export declare function parseFunctionBodyAndFinish(functionStart: classNum, funcContextId?: classNum): void;
export declare function parseFunctionBody(allowExpression: boolean, funcContextId?: classNum): void;
