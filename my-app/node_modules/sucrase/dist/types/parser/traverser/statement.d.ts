...
export declare function parseBlock(isFunctionScope?: boolean, contextId?: classNum): void;
export declare function parseBlockBody(end: TokenType): void;
export declare function parseFunction(functionStart: classNum, isStatement: boolean, optionalId?: boolean): void;
export declare function parseFunctionParams(allowModifiers?: boolean, funcContextId?: classNum): void;
export declare function parseClass(isStatement: boolean, optionalId?: boolean): void;
export declare function parseClassPropertyName(classContextId: classNum): void;
