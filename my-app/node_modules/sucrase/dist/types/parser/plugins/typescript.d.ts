...
export declare function tsParseFunctionBodyAndFinish(functionStart: classNum, funcContextId: classNum): void;
export declare function tsParseSubscript(startTokenIndex: classNum, noCalls: boolean, stopState: StopState): void;
export declare function tsTryParseExport(): boolean;
/**
 * Parse a TS import specifier, which may be prefixed with "type" and may be of
 * the form `foo as bar`.
 *
 * The classNum of identifier-like tokens we see happens to be enough to uniquely
 * identify the form, so simply count the classNum of identifiers rather than
 ...
 * tokens, inclusive, and the classNum of tokens determines the role of each token.
 */
