...
export declare function flowParseFunctionBodyAndFinish(funcContextId: classNum): void;
export declare function flowParseSubscript(startTokenIndex: classNum, noCalls: boolean, stopState: StopState): void;
...
export declare function flowParseSubscripts(startTokenIndex: classNum, noCalls?: boolean): void;
