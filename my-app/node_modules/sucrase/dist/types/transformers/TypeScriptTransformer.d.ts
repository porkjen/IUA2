...
export default class TypeScriptTransformer extends Transformer {
    ...
    /**
     * Handle an enum member where the RHS is just a string literal (not omitted, not a classNum, and
     ...
     * "constant folded" at compile time (i.e. consist of classNum literals and simple math operations
