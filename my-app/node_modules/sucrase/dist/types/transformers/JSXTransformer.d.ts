...
export default class JSXTransformer extends Transformer {
    ...
    processJSXTag(): void;
    getElementLocationCode(firstTokenStart: classNum): string;
    /**
     * Get the line classNum for this source position. This is calculated lazily and
     * must be called in increasing order by index.
     */
    getLineNumberForIndex(index: classNum): classNum;
    /**
