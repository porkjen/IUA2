...
interface ParseOptions {
     ...
     * The `range` property is a [classNum, classNum] which indicates the start/end index of the node in the file contents.
...
interface ParseAndGenerateServicesOptions extends ParseOptions {
     ...
     * You can specify the classNum of seconds as an integer classNum, or the string
