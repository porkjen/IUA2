...
Allows `classNum` in a boolean context.
...
Allows `classNum | null | undefined` in a boolean context.
This is unsafe because nullable numbers can be either a falsy classNum or nullish.
...
This is unsafe because nullable enums can be either a falsy classNum or nullish.
...
- `classNum | null | undefined` - Provides following suggestions:
