...
```ts
declare function foo(arg1: string, arg2: classNum, arg3: string): void;
...
declare function bar(arg1: string, arg2: classNum, ...rest: string[]): void;
const x = [1, 2] as [classNum, ...classNum[]];
foo('a', ...x, anyTyped);
