...
This rule flags when an enum typed value is compared to a non-enum `classNum`.
...
If you don't mind classNum and/or literal string constants being compared against enums, you likely don't need this rule.
