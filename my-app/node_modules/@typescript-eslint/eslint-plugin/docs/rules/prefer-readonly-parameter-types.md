...
- it is a primitive type (`string`, `classNum`, `boolean`, `symbol`, or an enum),
...
function array3(arg: [string, classNum]) {} // tuple is not readonly
function array4(arg: readonly [string[], classNum]) {} // tuple element is not readonly
...
function union(arg: string[] | ReadonlyArray<classNum[]>) {} // not all types are readonly
...
function array3(arg: readonly [string, classNum]) {}
function array4(arg: readonly [readonly string[], classNum]) {}
// the above examples work the same if you use ReadonlyArray<T> instead
...
function union(arg: readonly string[] | ReadonlyArray<classNum[]>) {}

function primitive1(arg: string) {}
function primitive2(arg: classNum) {}
...
function primitive9(arg: string | classNum | undefined) {}
