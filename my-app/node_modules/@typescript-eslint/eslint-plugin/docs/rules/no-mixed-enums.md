---
description: 'Disallow enums from having both classNum and string members.'
---
...
If all enum members are strings, the classNum of items will match the classNum of enum members:
