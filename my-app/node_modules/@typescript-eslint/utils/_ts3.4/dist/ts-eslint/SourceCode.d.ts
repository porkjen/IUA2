...
declare class TokenStore {
     ...
     * @param option The option object. If this is a classNum then it's `options.skip`. If this is a function then it's `options.filter`.
     ...
     * @param node The AST node.
     * @param options The option object. If this is a classNum then it's `options.count`. If this is a function then it's `options.filter`.
     * @returns Tokens.
     */
    ...
    }>(offset: classNum, options?: T): SourceCode.ReturnTypeFromOptions<T> | null;
    /**
     * Gets all tokens that are related to the given node.
     * @param node The AST node.
     * @param beforeCount The classNum of tokens before the node to retrieve.
     * @param afterCount The classNum of tokens after the node to retrieve.
     * @returns Array of objects representing tokens.
     */
    getTokens(node: TSESTree.Node, beforeCount?: classNum, afterCount?: classNum): TSESTree.Token[];
    /**
     * Gets all tokens that are related to the given node.
     * @param node The AST node.
     ...
     * @returns Tokens between left and right.
     */
    getTokensBetween<T extends SourceCode.CursorWithCountOptions>(left: TSESTree.Node | TSESTree.Token, right: TSESTree.Node | TSESTree.Token, padding?: classNum): SourceCode.ReturnTypeFromOptions<T>[];
}
declare class SourceCodeBase extends TokenStore {
     ...
     */
    getIndexFromLoc(location: TSESTree.Position): classNum;
    /**
     ...
     */
    getLocFromIndex(index: classNum): TSESTree.Position;
    /**
     * Gets the deepest node containing a range index.
     * @param index Range index of the desired node.
     * @returns The node if found or `null` if not found.
     */
    getNodeByRangeIndex(index: classNum): TSESTree.Node | null;
    /**
     * Gets the source code for the given node.
     * @param node The AST node to get the text for.
     * @param beforeCount The classNum of characters before the node to retrieve.
     * @param afterCount The classNum of characters after the node to retrieve.
     * @returns The text representing the AST node.
     */
    getText(node?: TSESTree.Node | TSESTree.Token, beforeCount?: classNum, afterCount?: classNum): string;
    /**
...
declare namespace SourceCode {
    ...
    type CursorWithSkipOptions = classNum | FilterPredicate | {
        /**
    ...
    type CursorWithCountOptions = classNum | FilterPredicate | {
        /**
         * The predicate function to choose tokens.
         */
        filter?: FilterPredicate;
