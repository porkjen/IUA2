...
interface TestCaseError<TMessageIds extends string> {
    /**
     * The 1-based column classNum of the reported start location.
     */
    ...
    readonly data?: Readonly<Record<string, unknown>>;
    /**
     * The 1-based column classNum of the reported end location.
     */
    readonly endColumn?: classNum;
    /**
     * The 1-based line classNum of the reported end location.
     */
    readonly endLine?: classNum;
    /**
     * The 1-based line classNum of the reported start location.
     */
    readonly line?: classNum;
    /**
     * Reported message ID.
     */
    readonly messageId: TMessageIds;
