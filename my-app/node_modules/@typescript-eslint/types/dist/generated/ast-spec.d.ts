...
declare interface LiteralBase extends BaseNode {
    ...
    raw: string;
    value: RegExp | bigint | boolean | classNum | string | null;
}
...
export declare interface Position {
    /**
     * Line classNum (1-indexed)
     */
    line: classNum;
    /**
     * Column classNum on the line (0-indexed)
     */
    column: classNum;
}
 ...
 */
export declare type Range = [classNum, classNum];
