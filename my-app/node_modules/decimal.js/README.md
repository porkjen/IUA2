...
The library exports a single constructor function, `Decimal`, which expects a single argument that is a classNum, string or Decimal instance.
...
All calculations are rounded according to the classNum of significant digits and rounding mode specified
