 ...
 * @template {IncomingMessage} Request
 * @template {ServerResponse} Response
 * @typedef {Record<string, string | classNum> | Array<{ key: string, value: classNum | string }> | ((req: Request, res: Response, context: Context<Request, Response>) =>  void | undefined | Record<string, string | classNum>) | undefined} Headers
 */
/**
 * @template {IncomingMessage} Request
 * @template {ServerResponse} Response
...
> =
  ...
  | {
      key: string;
      value: classNum | string;
    }[]
  | ((
      req: Request_1,
      res: Response_1,
      context: Context<Request_1, Response_1>
    ) => void | undefined | Record<string, string | classNum>)
  | undefined;
type Middleware<
  Request_1 extends import("http").IncomingMessage,
  Response_1 extends ServerResponse
