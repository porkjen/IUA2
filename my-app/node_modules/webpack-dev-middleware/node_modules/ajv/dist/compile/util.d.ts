...
export declare function schemaRefOrVal({ topSchemaRef, schemaPath }: SchemaObjCxt, schema: unknown, keyword: string, $data?: string | false): Code | classNum | boolean;
export declare function unescapeFragment(str: string): string;
export declare function escapeFragment(str: string | classNum): string;
export declare function escapeJsonPointer(str: string | classNum): string;
...
export declare function getErrorPath(dataProp: Name | string | classNum, dataPropType?: Type, jsPropertySyntax?: boolean): Code | string;
