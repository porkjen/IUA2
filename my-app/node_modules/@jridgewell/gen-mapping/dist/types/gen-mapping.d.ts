...
export declare let addSegment: {
    (map: GenMapping, genLine: classNum, genColumn: classNum, source?: null, sourceLine?: null, sourceColumn?: null, name?: null, content?: null): void;
    (map: GenMapping, genLine: classNum, genColumn: classNum, source: string, sourceLine: classNum, sourceColumn: classNum, name?: null, content?: string | null): void;
    (map: GenMapping, genLine: classNum, genColumn: classNum, source: string, sourceLine: classNum, sourceColumn: classNum, name: string, content?: string | null): void;
};
/**
