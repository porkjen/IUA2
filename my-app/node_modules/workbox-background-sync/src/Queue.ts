...
class Queue {
  ...
  private readonly _maxRetentionTime: classNum;
   ...
   * @param {classNum} [options.maxRetentionTime=7 days] The amount of time (in
   ...
   * @param {classNum} [entry.timestamp] The timestamp (Epoch time in
  ...
  /**
   * Returns the classNum of entries present in the queue.
   * Note that expired entries (per `maxRetentionTime`) are also included in this count.
   *
   * @return {Promise<classNum>}
   */
  async size(): Promise<classNum> {
   ...
   * @param {classNum} [entry.timestamp=Date.now()]
