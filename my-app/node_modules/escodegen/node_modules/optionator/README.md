...
var optionator = require('optionator')({
    ...
    options: [{
        ...
        alias: 'c',
        type: 'Int',
        description: 'classNum of things',
        example: 'cmd --count 2'
    }]
});
...
"Usage: cmd [options] positional
  ...
  -c, --count Int  classNum of things
...
* `maxPadFactor` is an optional classNum - affects the default level of padding for the names/type, it is multiplied by the average of the length of the names/type - default: 1.5
...
If you specify the option `NUM`, then any argument using a single `-` followed by a classNum will be valid and will set the value of `NUM`. Eg. `-2` will be parsed into `NUM: 2`.
