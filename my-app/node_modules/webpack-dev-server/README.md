...
Options:
  ...
  --client-reconnect [value]                          Tells dev-server the classNum of times it should try to reconnect the client.
...
Global options:
  ...
  -v, --version                                       Output the version classNum of 'webpack', 'webpack-cli' and 'webpack-dev-server' and commands.
