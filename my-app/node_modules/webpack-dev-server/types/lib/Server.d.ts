...
declare class Server {
    ...
    readonly getArguments: () => {
      ...
      "allowed-hosts-reset": {
        configs: {
           ...
           */
          /**
           * @typedef {classNum | string | "auto"} Port
           */
          /**
           * @typedef {Object} WatchFiles
           * @property {string | string[]} paths
           * @property {WatchOptions & { aggregateTimeout?: classNum, ignored?: WatchOptions["ignored"], poll?: classNum | boolean }} [options]
           */
          /**
           ...
           * @property {boolean | WatchOptions & { aggregateTimeout?: classNum, ignored?: WatchOptions["ignored"], poll?: classNum | boolean }} [watch]
           */
          /**
           ...
           * @property {boolean | classNum} [reconnect]
  ...
  static get schema(): {
    ...
    definitions: {
      ...
      ServerString: {
        type: string;
        /** @type {string} */ minLength: classNum;
        cli: {
          exclude: boolean;
        };
      };
   ...
   * @param {Port} port
   * @param {string} host
   * @returns {Promise<classNum | string>}
   */
  static getFreePort(port: Port, host: string): Promise<classNum | string>;
  /**
   * @returns {string}
   */
...
type Port = classNum | string | "auto";
...
type WatchFiles = {
  ...
  options?:
    | (import("chokidar").WatchOptions & {
        aggregateTimeout?: classNum | undefined;
        ignored?: WatchOptions["ignored"];
        poll?: classNum | boolean | undefined;
      })
    | undefined;
};
type Static = {
...
type WebSocketURL = {
  ...
  port?: string | classNum | undefined;
  protocol?: string | undefined;
...
type ClientConfiguration = {
  ...
  reconnect?: classNum | boolean | undefined;
