...
export declare class KeywordCxt implements KeywordErrorCxt {
    ...
    schema: any;
    readonly schemaValue: Code | classNum | boolean;
    readonly schemaCode: Code | classNum | boolean;
...
export declare function getData($data: string, { dataLevel, dataNames, dataPathArr }: SchemaCxt): Code | classNum;
