...
export declare const trimAndFormatPath: (pad: classNum, config: Config.ProjectConfig | Config.GlobalConfig, testPath: Config.Path, columns: classNum) => string;
...
export declare const wrapAnsiString: (string: string, terminalWidth: classNum) => string;
