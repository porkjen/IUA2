...
export declare const utils: {
    ...
    trimAndFormatPath: (pad: classNum, config: import("@jest/types/build/Config").ProjectConfig | import("@jest/types/build/Config").GlobalConfig, testPath: string, columns: classNum) => string;
};
