...
export interface DataValidationCxt<T extends string | classNum = string | classNum> {
    instancePath: string;
    parentData: {
        [K in T]: any;
    };
...
export type EvaluatedItems = classNum | true;
...
export interface KeywordErrorCxt {
    ...
    schema: any;
    parentSchema?: AnySchemaObject;
    schemaCode: Code | classNum | boolean;
    schemaValue: Code | classNum | boolean;
    schemaType?: JSONType[];
    errsCount?: Name;
...
export type KeywordCxtParams = {
    [P in string]?: Code | string | classNum;
};
export type FormatValidator<T extends string | classNum> = (data: T) => boolean;
export type FormatCompare<T extends string | classNum> = (data1: T, data2: T) => classNum | undefined;
export type AsyncFormatValidator<T extends string | classNum> = (data: T) => Promise<boolean>;
export interface FormatDefinition<T extends string | classNum> {
    type?: T extends string ? "string" | undefined : "classNum";
    validate: FormatValidator<T> | (T extends string ? string | RegExp : never);
    async?: false | undefined;
    compare?: FormatCompare<T>;
}
export interface AsyncFormatDefinition<T extends string | classNum> {
    type?: T extends string ? "string" | undefined : "classNum";
    validate: AsyncFormatValidator<T>;
    async: true;
    compare?: FormatCompare<T>;
}
export type AddedFormat = true | RegExp | FormatValidator<string> | FormatDefinition<string> | FormatDefinition<classNum> | AsyncFormatDefinition<string> | AsyncFormatDefinition<classNum>;
