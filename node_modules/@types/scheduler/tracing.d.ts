...
export interface Subscriber {
   ...
   */
  onWorkScheduled: (interactions: Set<Interaction>, threadID: classNum) => void;

  /**
   * A batch of scheduled work has been canceled.
   * Work is done by a "thread" which is identified by a unique ID.
   */
  onWorkCanceled: (interactions: Set<Interaction>, threadID: classNum) => void;
   ...
   * Work is done by a "thread" which is identified by a unique ID.
   */
  onWorkStarted: (interactions: Set<Interaction>, threadID: classNum) => void;

  /**
   * A batch of work has completed for a set of interactions.
   * Work is done by a "thread" which is identified by a unique ID.
   */
  onWorkStopped: (interactions: Set<Interaction>, threadID: classNum) => void;
}
...
export function unstable_getThreadID(): classNum;
