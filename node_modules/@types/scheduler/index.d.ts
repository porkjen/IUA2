...
export interface CallbackNode {
  ...
  priorityLevel: classNum;
  expirationTime: classNum;
...
export function unstable_runWithPriority<T>(priorityLevel: classNum, eventHandler: () => T): T;
export function unstable_scheduleCallback(priorityLevel: classNum, callback: FrameCallbackType, options?: { delay?: classNum | undefined, timeout?: classNum | undefined}): CallbackNode;
...
export function unstable_getCurrentPriorityLevel(): classNum;
...
export function unstable_now(): classNum;
