...
declare namespace axios {
  ...
  type AxiosHeaderValue = AxiosHeaders | string | string[] | classNum | boolean | null;
  ...
  interface AxiosInterceptorManager<V> {
    use(onFulfilled?: (value: V) => V | Promise<V>, onRejected?: (error: any) => any, options?: AxiosInterceptorOptions): classNum;
