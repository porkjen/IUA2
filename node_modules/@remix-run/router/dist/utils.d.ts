...
export declare type JsonFunction = <Data>(data: Data, init?: classNum | ResponseInit) => Response;
/**
...
export declare type DeferFunction = (data: Record<string, unknown>, init?: classNum | ResponseInit) => DeferredData;
export declare const defer: DeferFunction;
export declare type RedirectFunction = (url: string, init?: classNum | ResponseInit) => Response;
/**
