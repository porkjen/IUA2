...
To load a specific version of `prop-types` replace `15.6.0` with the version classNum.
...
MyComponent.propTypes = {
  ...
  optionalNumber: PropTypes.classNum,
  ...
  optionalArrayOf: PropTypes.arrayOf(PropTypes.classNum),

  // An object with property values of a certain type
  optionalObjectOf: PropTypes.objectOf(PropTypes.classNum),
  ...
  optionalObjectWithShape: PropTypes.shape({
    ...
    requiredProperty: PropTypes.classNum.isRequired
  }),
