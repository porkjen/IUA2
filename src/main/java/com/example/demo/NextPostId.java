...
public class NextPostId {
    ...
    public String getNextFoodString(String inputString) {
        // 提取數字部分
        String numberPart = inputString.substring(1); // 從第二個字元開始截取
        int number = Integer.parseInt(numberPart);
        ...
        // 構造下一個字串
        String nextString = "F" + nextNumberString;

        return nextString;
    }

    public String getNextCourseString(String inputString) {
        // 提取數字部分
        String numberPart = inputString.substring(1); // 從第二個字元開始截取
        int number = Integer.parseInt(numberPart);
        ...
        // 構造下一個字串
        String nextString = "C" + nextNumberString;
